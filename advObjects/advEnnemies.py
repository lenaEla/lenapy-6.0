...
liaSkill = skill("Douce caresse","liaSkill",TYPE_DAMAGE,0,power=70,effect=[charming,charming,charming,charming],knockback=1,cooldown=5,use=MAGIE,say="Roh allez, détent toi un peu !",emoji='<:liaSkill:922291249002709062>')
liuSkillEff = effect("Endurance Terrestre","liuSkillEff",MAGIE,overhealth=120,aggro=15,inkResistance=10,type=TYPE_ARMOR,trigger=TRIGGER_DAMAGE,emoji=uniqueEmoji('<:liuArmor:922292960886915103>'))
liuSkill = skill("Reconstitution","liuSkill",TYPE_DAMAGE,0,power=100,use=MAGIE,cooldown=2,effectOnSelf=liuSkillEff,say="Oh je suis pas encore finie tu va voir !",emoji='<:liuSkill:922328931502280774>')
...
tablBoss = [
    ...
    octarien("Kiku",0,100,50,120,100,5,350,25,35,0,kikuBossWeap,10,'<:kiku:921704515332358174>',[kikuBossRes,kikuUltimaFerrum],gender=GENDER_FEMALE,deadIcon ='<:kikuOut:921709153892831294>',baseLvl=15,rez=False,element=ELEMENT_EARTH)
]
