...
# --------------------------------------------------------- Tabl Unique Ennemis ---------------------------------------------------------
tablUniqueEnnemies = [
    octarien("Octo Bouclier",50,350,20,45,45,20,10,50,0,0,octoShieldWeap,5,'<:OctoShield:881587820530139136>',[octaStrans,blindage,isolement,shieldBubble],team=NPC_OCTARIAN,description="Un octarien qui se cache derrière un gros et lourd bouclier",number=2,aspiration=MASCOTTE),
    octarien("Octo Tireur",150,55,50,95,155,35,0,20,0,20,octoBallWeap,3,'<:octoshooter:880151608791539742>',[chargeShot,ultraShot],team=NPC_OCTARIAN,description="Un tireur sans plus ni moins",number=3,aspiration=OBSERVATEUR),
    octarien("Octo Soigneur",30,100,250,35,15,50,50,25,0,0,octoHeal,4,"<:octohealer:880151652710092901>",[lightAura,cure,firstheal],team=NPC_OCTARIAN,aspiration=ALTRUISTE,description="Un octarien qui se spcésialise dans ~~passer son tour~~ soigner ses alliés",number=3),
    ...
    octarien("Aéro-benne",200,50,50,60,150,35,20,20,0,0,flyfishweap,7,'<:flyFish:1034364608070291457>',description="Un Salmioche qui s'est passionné pour l'aviation",team=NPC_SALMON,deadIcon='<:salmonnt:894551663950573639>',aspiration=OBSERVATEUR,baseLvl=10,number=2),
    ...
    octarien("Octo Moine",175,125,30,35,75,75,50,30,0,20,mainLibre,5,'<:octoMonk:907723929882337311>',[airStrike,earthStrike,None,None,None,None,maitriseElementaire],BERSERK,baseLvl=15,number=2,element=ELEMENT_UNIVERSALIS_PREMO,team=NPC_OCTARIAN),
    octarien("Octo Scientifique",10,25,120,75,35,250,10,30,0,0,octoBoostWeap,7,"<:octoScience:915054617933541386>",[octoBoostSkill1,octoBoostSkill2,octoBoostSkill3,octoBoostSkill4,zoneOctoInkRes],INOVATEUR,number=2,team=NPC_OCTARIAN),
    ...
    octarien("Liu",30,300,80,0,50,100,0,60,0,10,liuWeap,10,'<:liu:908754674449018890>',[liuSkill,liuMontBreaker,liuAoEShieldSkill,liuFurTelCast,liuEarthCircle,liuLB],PROTECTEUR,GENDER_FEMALE,"La plus sportive de sa fratterie\n\nChaque attaque à l'arme des Soeurs Kitsune applique l'état \"Charmé (Ennemi)\" qui diminue légèrement les statistiques de la cible","<:kitsuSisterDead:908756093101015100>",baseLvl=20,say=liuSays,element=ELEMENT_EARTH,elemAffinity=True,splashIcon='<:liu:1079013404804665484>',team=NPC_KITSUNE),
    octarien("Lia",10,40,170,250,50,50,0,30,0,0,liaWeap,10,'<:lia:908754741226520656>',[liaPassive, liaWindBite, liaDash, liaLB, liaSillage, liaSkill5],POIDS_PLUME,GENDER_FEMALE,"La plus rapide et agile de sa fraterie\n\nChaque attaque à l'arme des Soeurs Kitsune applique l'état \"Charmé (Ennemi)\" qui diminue légèrement les statistiques de la cible","<:kitsuSisterDead:908756093101015100>",baseLvl=20,say=liaSays,element=ELEMENT_AIR,elemAffinity=True,splashIcon='<:lia:1079017951098847283>',team=NPC_KITSUNE),
    octarien("Lio",20,70,250,75,50,35,80,35,0,0,lioWeap,10,'<:lio:908754690769043546>',[asile,lioRez,veterHealSkill2,lioHealZone,lioLB,misery,lioIndirectHeal],ALTRUISTE,GENDER_FEMALE,"La plus calme et tranquille de sa fraterie\n\nChaque attaque à l'arme des Soeurs Kitsune applique l'état \"Charmé (Ennemi)\" qui diminue légèrement les statistiques de la cible","<:kitsuSisterDead:908756093101015100>",baseLvl=20,say=lioSays,element=ELEMENT_WATER,elemAffinity=True,splashIcon='<:lio:1079030249213394996>',team=NPC_KITSUNE),
    octarien("Liz",10,55,135,35,20,35,205,35,20,0,lieWeap,10,'<:lie:908754710121574470>',[lizBoomCast,lizQuadBoom,lieSkill,lizDotAoE,lizAoE,lizDespairFire,lizLB],MAGE,GENDER_FEMALE,"La plus impulsive de sa fraterie\n\nChaque attaque à l'arme des Soeurs Kitsune applique l'état \"Charmé (Ennemi)\" qui diminue légèrement les statistiques de la cible","<:kitsuSisterDead:908756093101015100>",baseLvl=20,say=lizSays,element=ELEMENT_FIRE,elemAffinity=True,splashIcon='<:liz:1079024673205014609>',team=NPC_KITSUNE),
    ...
    octarien("Octo Gazeur",200,70,10,50,35,200,0,50,35,0,octoGazWeap,6,'<:octogazeur:972160938104979516>',[octoGazSkill1,octoGazSkill2,octoGazSkill3],ATTENTIF,baseLvl=10,team=NPC_OCTARIAN,element=ELEMENT_DARKNESS,number=2),
    ...
    octarien("Sorcière",20,100,25,50,75,135,200,35,10,0,witchWeapon,7,"<:witch:1034363858262949918>",[witchSkill,strengthOfDesepearance,witchPoisonSpell,witchRageSpell,None,None,zombieUndead],SORCELER,GENDER_FEMALE,"Une sorcière ayant étudié la magie noir pour pouvoir ramener temporairement les morts à la vie","<:ghost:894550239204220958>",baseLvl=15,rez=False,number=2,team=NPC_UNDEAD),
    ...
    octarien("Golem des Flots",0,100,0,0,120,80,295,30,0,15,waterGolemWeapon,6,"<:waterGolem:1064115595676766248>",[waterGolemSkill1,waterGolemSkill2,imeaSkill2],MAGE,baseLvl=15,number=2,elemAffinity=True,element=[ELEMENT_WATER,ELEMENT_WATER],team=NPC_GOLEM,description="Un golem créé par Nacialisla pour aider la nature à reprendre ses droits"),
    octarien("Bandit Surrineur",200,150,0,150,75,20,0,30,15,0,surrinWeap,5,"<:surin:1113685316319072297>",[surrinSkill1,surrinSkill2],POIDS_PLUME,description="Un bandit utilisant des surrins qui se dissimule pour prendre ses ennemis par surprise",baseLvl=10,number=3),
    octarien("Bandit Archer",200,70,0,50,200,50,0,30,15,0,bowWeap,5,"<:bow:1113685339400327198>",[bowSkill1,bowSkill2],ATTENTIF,description="Un bandit utilisant un arc pour empoissonner ses cibles à distance",baseLvl=10,number=3),
...
tablBoss = [
    ...
    octarien("Luna ex.",450,80,80,185,75,80,0,25,35,0,lunaWeap,80,'<:luna:909047362868105227>',[lunaSpeCast,lunaSkill,lunaSkill5Base,lunaSkill2,lunaSkill4,lunaSkill6,lunaSkill7],POIDS_PLUME,GENDER_FEMALE,lunaDesc,'<:spIka:866465882540605470>',True,say=lunaBossSays,element=ELEMENT_DARKNESS),
