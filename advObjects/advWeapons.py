...
roller = weapon("Rouleau","ac",RANGE_MELEE,AREA_CIRCLE_1,64,70,340,strength=10,endurance=10,resistance=10,emoji = '<:splatroller:866367775722831934>',needRotate=False,affinity=ELEMENT_AIR,area=AREA_CONE_2,damageOnArmor=0.8)
...
miniBrush = weapon("Epinceau","ae",RANGE_MELEE,AREA_CIRCLE_1,28,45,224,agility=10,charisma=10,endurance=10,repetition=5,emoji='<:inkBrush:866463573580578816>',needRotate=False)
inkbrella = weapon("Para-Encre","ag",RANGE_MELEE,AREA_CIRCLE_1,38,45,price=472,endurance=5,resistance=10,repetition=3,effects='lp',emoji='<:splatbrella:866464991255199834>',needRotate=False)
...
kcharger = weapon("Concentraceur alt.","ak",RANGE_MELEE,AREA_CIRCLE_1,36,60,200,strength=15,agility=15,repetition=3,emoji='<:kcharger:870870886939508737>',message="{0} frappe {1} avec son arme :",use=STRENGTH)
HunterRiffle = weapon("Fusil de chasseur","al",RANGE_DIST,AREA_CIRCLE_4,67,65,250,precision=15,effects="ls",emoji="<:hunterRifle:872034208095297597>",affinity=ELEMENT_NEUTRAL)
...
butterfly = weapon("Papillon Blanc","aw",RANGE_LONG,AREA_CIRCLE_5,35,80,150,taille=0,charisma=20,use=CHARISMA,intelligence=10,emoji='<:butterflyB:883627125561786428>',target=ALLIES,type=TYPE_HEAL,needRotate=False,message="{0} demande à son papillon de soigner {1} :")
...
rapiere = weapon("Rapière en argent","bg",RANGE_DIST,AREA_CIRCLE_3,63,60,0,magie=5,intelligence=5,percing=5,use=MAGIE,emoji='<:clemWeap:915358467773063208>',effectOnUse=coroWind,effPowerPurcent=70)
...
serringue = weapon("Serringue","bi",RANGE_DIST,AREA_CIRCLE_3,35,100,350,charisma=30,emoji='<:seringue:887402558665142343>',target=ALLIES,type=TYPE_HEAL,use=CHARISMA,affinity=ELEMENT_LIGHT,message="{0} fait une perfusion à {1}")
...
lightSpellBook = weapon("Grimoire de la lumière","bu",RANGE_DIST,AREA_CIRCLE_4,20,100,350,charisma=10,intelligence=5,effectOnUse="mt",type=TYPE_HEAL,use=CHARISMA,target=ALLIES,taille=0,emoji='<:lightspellbook:892963432222036018>',affinity=ELEMENT_LIGHT)
...
gwenCoupe = weapon("Ciseaux de la poupée","bw",RANGE_MELEE,AREA_CIRCLE_1,9,60,price=1,repetition=5,area=AREA_CONE_2,magie=10,resistance=5,emoji='<:gwencoupecoupe:902912449261473875>',effects="ob",use=MAGIE)
inkbrella2 = weapon("Para-Encre alt.","bx",RANGE_MELEE,AREA_CIRCLE_1,30,45,price=472,endurance=5,resistance=5,intelligence=5,repetition=3,use=INTELLIGENCE,effects='ok',emoji='<:heroInkBrella:905282148917993513>',needRotate=False)
...
klikliSword = weapon("Épée vengeresse","ca",RANGE_MELEE,AREA_CIRCLE_1,50,65,1,repetition=2,emoji='<:KlikliSword:907300288531169340>',strength=20,resistance=10)
...
krystalFist = weapon("Poings cristalins","ci",RANGE_MELEE,AREA_CIRCLE_1,36,60,price=1,repetition=3,strength=5,resistance=15,endurance=10,emoji='<:krystalopoings:916120173130448948>')
...
eternalInkSword = weapon("Épée de l'Encre Éternelle","cj",RANGE_MELEE,AREA_CIRCLE_1,69,75,1,strength=15,effects=eternalInkEff,emoji='<:inkEtSword:918071301913079808>',needRotate=False)
eternalInkStick = weapon("Dague de l'Encre Éternelle","ck",RANGE_MELEE,AREA_CIRCLE_1,54,75,1,agility=15,effects=eternalInkEff,taille=0,use=AGILITY,emoji='<:inkEtDague:918083344250568734>',needRotate=False)
eternalInkShield = weapon("Bouclier de l'Encre Éternelle","cl",RANGE_MELEE,AREA_CIRCLE_1,54,75,1,endurance=15,effects=eternalInkEff,taille=0,use=ENDURANCE,emoji='<:inkEtShield:918083377712734251>',needRotate=False)
eternalInkStaff = weapon("Baguette de l'Encre Éternelle","cm",RANGE_DIST,AREA_CIRCLE_4,46,75,1,magie=15,effects=eternalInkEff,use=MAGIE,emoji='<:inkEtStick:918083398956900392>',needRotate=False)
eternalInkWind = weapon("Éventail de l'Encre Éternelle","cn",RANGE_DIST,AREA_CIRCLE_4,46,75,1,charisma=15,effects=eternalInkEff,taille=0,use=CHARISMA,emoji='<:inkEtFan:918083360545443870>',needRotate=False)
eternalInkScience = weapon("Gant de l'Encre Éternelle","co",RANGE_DIST,AREA_CIRCLE_4,46,75,1,intelligence=15,effects=eternalInkEff,taille=0,use=INTELLIGENCE,emoji='<:inkEtGlove:918083419081170954>',needRotate=False)
eternalInkBow = weapon("Arc de l'Encre Éternelle","cp",RANGE_LONG,AREA_CIRCLE_6,37,75,1,precision=15,effects=eternalInkEff,use=PRECISION,emoji='<:inkEtBow:918083434860146710>',needRotate=False)
...
cardBer = effect("La balance berserk",'BerCard',CHARISMA,strength=5,resistance=3,emoji='<:balance:932399888422043739>')
...
cardEnch = effect("La tour enchantée",'EncCard',CHARISMA,magie=5,resistance=3,emoji='<:tour:932399958936657921>')
...
cardPro = effect("L'aiguilère ponctuelle",'ProCard',CHARISMA,resistance=3,intelligence=5,emoji='<:aiguilere:932399946659921990>')
cardSorc = effect("La tour intemporelle",'SorCard',CHARISMA,magie=5,intelligence=5,emoji='<:tour:932399958936657921>')
cardVig = effect('Le tronc solide',"vigiCard",CHARISMA,charisma=5,resistance=3,emoji='<:tronc:932399933724700763>')
...
cardAtt = effect("La flèche empoisonnée",'ObsCard',CHARISMA,strength=5,intelligence=5,emoji='<:fleche:932399905807433738>')
cardMas = effect("L'épieu versatil",'MasCard',CHARISMA,charisma=5,endurance=5,emoji='<:epieu:932399920873357382>')
...
trislosher = weapon("Dépoteur",'dj',RANGE_MELEE,AREA_CIRCLE_1,37,60,1,strength=10,endurance=10,agility=10,emoji='<:trislosher:936782121450741800>',area=AREA_CONE_2,repetition=2)
...
miltrilPlanisphere = weapon("Planisphère en mithril", 'dk', RANGE_LONG, AREA_CIRCLE_5, 27, 80, 1, area=AREA_CIRCLE_1, charisma=7, intelligence=7,endurance=1, effects=miltrilPlanisftEff, use=INTELLIGENCE, emoji='<:planisMitrill:938379244856291388>',priority=WEAPON_PRIORITY_LOW)
...
fireMetRuneLong = weapon("Rune allongée des flammes","dl",RANGE_LONG,AREA_CIRCLE_6,33,60,1,magie=10,percing=5,area=AREA_CIRCLE_1,effects=tablWeapExp[0],use=MAGIE,emoji='<:fireLong:957759716484849754>',affinity=ELEMENT_FIRE,taille=0,priority=WEAPON_PRIORITY_HIGH)
fireMetRuneMel = weapon("Rune de proximité des flammes","dm",RANGE_MELEE,AREA_CIRCLE_2,48,60,1,magie=10,resistance=5,area=AREA_CIRCLE_1,effects=tablWeapExp[0],use=MAGIE,emoji='<:fireMele:957759749716336640>',affinity=ELEMENT_FIRE,taille=0,priority=WEAPON_PRIORITY_HIGH)
waterMetRuneLong = weapon("Rune allongée des courants","dn",RANGE_LONG,AREA_CIRCLE_6,46,60,1,magie=10,percing=5,effects=tablWeapExp[1],use=MAGIE,emoji='<:aqualong:957759791697125447>',affinity=ELEMENT_WATER,taille=0,priority=WEAPON_PRIORITY_HIGH)
waterMetRuneMel = weapon("Rune de proximité des courants","do",RANGE_MELEE,AREA_CIRCLE_2,68,60,1,magie=10,resistance=5,effects=tablWeapExp[1],use=MAGIE,emoji='<:aquaMel:957759818393870336>',affinity=ELEMENT_WATER,taille=0,priority=WEAPON_PRIORITY_HIGH)
airMetRuneMid = weapon("Rune étendue des vents","dp",RANGE_DIST,AREA_CIRCLE_4,40,60,1,magie=10,critical=5,area=AREA_CIRCLE_1,effects=tablWeapExp[2],use=MAGIE,emoji='<:airMid:957759962799562752>',affinity=ELEMENT_AIR,taille=0,priority=WEAPON_PRIORITY_HIGH)
airMetRuneMel = weapon("Rune de proximité des vents","dq",RANGE_MELEE,AREA_CIRCLE_2,48,60,1,magie=10,resistance=5,area=AREA_CIRCLE_1,effects=tablWeapExp[2],use=MAGIE,emoji='<:airMel:957759933359751239>',affinity=ELEMENT_AIR,taille=0,priority=WEAPON_PRIORITY_HIGH)
earthMetRuneMid = weapon("Rune étendue des sédiments","dr",RANGE_LONG,AREA_CIRCLE_4,58,60,1,magie=10,critical=5,effects=tablWeapExp[3],use=MAGIE,emoji='<:earthMid:957762288998305814>',affinity=ELEMENT_EARTH,taille=0,priority=WEAPON_PRIORITY_HIGH)
earthMetRuneMel = weapon("Rune de proximité des sédiments","ds",RANGE_MELEE,AREA_CIRCLE_2,68,60,1,magie=10,resistance=5,effects=tablWeapExp[3],use=MAGIE,emoji='<:earthMel:957759999227097118>',affinity=ELEMENT_EARTH,taille=0,priority=WEAPON_PRIORITY_HIGH)

lightMetRuneMid = weapon("Rune étendue des lueurs","dt",RANGE_DIST,AREA_CIRCLE_4,40,60,1,magie=10,percing=5,area=AREA_CIRCLE_1,effects=tablWeapExp[4],use=MAGIE,emoji='<:lightMid:957762377561014292>',affinity=ELEMENT_LIGHT,taille=0,priority=WEAPON_PRIORITY_HIGH)
lightMetRuneLong = weapon("Rune allongée des lueurs","du",RANGE_LONG,AREA_CIRCLE_6,33,60,1,magie=10,critical=5,area=AREA_CIRCLE_1,effects=tablWeapExp[4],use=MAGIE,emoji='<:lightLong:957762401963474994>',affinity=ELEMENT_LIGHT,taille=0,priority=WEAPON_PRIORITY_HIGH)
darkMetRuneMid = weapon("Rune étendue des ombres","dv",RANGE_DIST,AREA_CIRCLE_4,58,60,1,magie=10,critical=5,effects=tablWeapExp[5],use=MAGIE,emoji='<:darkMid:957762321709662339>',affinity=ELEMENT_DARKNESS,taille=0,priority=WEAPON_PRIORITY_HIGH)
darkMetRuneLong = weapon("Rune allongée des ombres","dw",RANGE_LONG,AREA_CIRCLE_6,46,60,1,magie=10,percing=5,effects=tablWeapExp[5],use=MAGIE,emoji='<:darkMel:957762348876169257>',affinity=ELEMENT_DARKNESS,taille=0,priority=WEAPON_PRIORITY_HIGH)
spaceMetRuneMid = weapon("Rune de proximité dimensionnelle","dx",RANGE_MELEE,AREA_CIRCLE_2,48,60,1,magie=10,resistance=5,area=AREA_CIRCLE_1,effects=tablWeapExp[6],use=MAGIE,emoji='<:spaceMel:957762429289369662>',affinity=ELEMENT_SPACE,taille=0,priority=WEAPON_PRIORITY_HIGH)
spaceMetRuneLong = weapon("Rune allongée dimensionnelle","dy",RANGE_LONG,AREA_CIRCLE_6,33,60,1,magie=10,percing=5,area=AREA_CIRCLE_1,effects=tablWeapExp[6],use=MAGIE,emoji='<:spaceLong:957762451515011112>',affinity=ELEMENT_SPACE,taille=0,priority=WEAPON_PRIORITY_HIGH)
timeMetRuneMid = weapon("Rune étendue temporelle","dz",RANGE_DIST,AREA_CIRCLE_4,58,60,1,magie=10,critical=5,effects=tablWeapExp[7],use=MAGIE,emoji='<:timeMid:957762503629226064>',affinity=ELEMENT_TIME,taille=0,priority=WEAPON_PRIORITY_HIGH)
timeMetRuneLong = weapon("Rune allongée temporelle","ea",RANGE_LONG,AREA_CIRCLE_6,46,60,1,magie=10,percing=5,effects=tablWeapExp[7],use=MAGIE,emoji='<:timeLong:957762475351244810>',affinity=ELEMENT_TIME,taille=0,priority=WEAPON_PRIORITY_HIGH)

iliSwoShield = weapon("Epée et Bouclier de la Lumière","eb",RANGE_MELEE,AREA_CIRCLE_1,54,75,1,resistance=5,charisma=10,effects=shieltron,use=CHARISMA,emoji='<:iliShield:975785889512976434>',affinity=ELEMENT_LIGHT)
flumShield = weapon("Epée et Bouclier de la Fleur Lumineuse","ec",RANGE_MELEE,AREA_CIRCLE_1,54,75,1,charisma=10,resistance=5,effects="lz",use=CHARISMA,affinity=ELEMENT_LIGHT,emoji='<:flumShield:964467183952465921>')
flumWand = weapon("Canne de la Fleur Lumineuse","ed",RANGE_LONG,AREA_CIRCLE_5,35,100,1,type=TYPE_HEAL,target=ALLIES,charisma=15,effects="lz",use=CHARISMA,affinity=ELEMENT_LIGHT,emoji='<:flumWand:964465128399568917>')
dflumShield = weapon("Epée et Bouclier de la Fleur Ténèbreuse","ef",RANGE_MELEE,AREA_CIRCLE_1,54,75,1,magie=10,resistance=5,effects="nt",use=MAGIE,affinity=ELEMENT_DARKNESS,emoji='<:darkShield:964467248486047765>')
