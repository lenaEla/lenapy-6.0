...
julieWeapEff = effect("Régénération vampirique","julieWeapEff",CHARISMA,type=TYPE_INDIRECT_HEAL,trigger=TRIGGER_START_OF_TURN,turnInit=3,lvl=3,power=5,stackable=True,emoji=uniqueEmoji('<:vampBall:916199488891273276>'))
julieWeap = weapon("Réceptacle vampirique","cb",RANGE_LONG,AREA_CIRCLE_6,50,100,500,charisma=15,type=TYPE_HEAL,target=ALLIES,use=CHARISMA,emoji='<:vampBall:916199488891273276>',effectOnUse=julieWeapEff)
