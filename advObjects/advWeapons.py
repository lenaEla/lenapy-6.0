...
legendarySword=weapon("Épée et Bouclier de Légende","az",RANGE_MELEE,AREA_CIRCLE_1,65,85,300,strength=10,resistance=5,emoji='<:masterSword:880008948445478962>',affinity=ELEMENT_LIGHT,effects=shieltron)
...
dtsword = weapon("Épée de Détermination","bd",RANGE_MELEE,AREA_CIRCLE_1,65,85,500,strength=10,resistance=5,emoji='<:dtSword:884802145239588884>',affinity=ELEMENT_NEUTRAL,effects="lg")
...
gwenCoupe = weapon("Ciseaux de la poupée","bw",RANGE_MELEE,AREA_CIRCLE_1,10,60,price=1,repetition=5,area=AREA_CONE_2,magie=10,resistance=5,emoji='<:gwencoupecoupe:902912449261473875>',effects="ob",use=MAGIE)
inkbrella2 = weapon("Para-Encre alt.","bx",RANGE_MELEE,AREA_CIRCLE_1,32,45,price=472,endurance=5,resistance=5,intelligence=5,repetition=3,use=INTELLIGENCE,effects='ok',emoji='<:heroInkBrella:905282148917993513>',needRotate=False)
...
eternalInkSword = weapon("Épée de l'Encre Éternelle","cj",RANGE_MELEE,AREA_CIRCLE_1,74,75,1,strength=15,effects=eternalInkEff,emoji='<:inkEtSword:918071301913079808>',needRotate=False)
eternalInkStick = weapon("Dague de l'Encre Éternelle","ck",RANGE_MELEE,AREA_CIRCLE_1,58,75,1,agility=15,effects=eternalInkEff,taille=0,use=AGILITY,emoji='<:inkEtDague:918083344250568734>',needRotate=False)
eternalInkShield = weapon("Bouclier de l'Encre Éternelle","cl",RANGE_MELEE,AREA_CIRCLE_1,58,75,1,endurance=15,effects=eternalInkEff,taille=0,use=ENDURANCE,emoji='<:inkEtShield:918083377712734251>',needRotate=False)
...
secretum = weapon("Secretum purpureum prædictas","cq",RANGE_DIST,AREA_CIRCLE_3,30,100,750,emoji='<:sdf:919713870858317875>',magie=10,resistance=5,effects=purpleSecretEff,use=MAGIE,affinity=ELEMENT_DARKNESS,ignoreAutoVerif=True)
...
grav = weapon("Gravité","cs",RANGE_MELEE,AREA_CIRCLE_1,56,99,1,endurance=10,taille=0,resistance=5,effects=gravEff,emoji='<:bl:925774629711282196>')
...
whiteSpiritWings = weapon("Ailes de l'esprit blanc","cu",RANGE_DIST,AREA_CIRCLE_4,46,75,1,taille=0,charisma=15,effects=kardia,use=CHARISMA,needRotate=False,emoji='<:wws:929847728077406279>',ignoreAutoVerif=True)
...
bleuSpiritWings = weapon("Ailes de l'esprit bleu","cv",RANGE_DIST,AREA_CIRCLE_4,46,75,1,intelligence=15,effects=eukrasia,use=INTELLIGENCE,needRotate=False,emoji='<:bws:929847711941935214>',ignoreAutoVerif=True)
...
cardMas = effect("L'épieu versatil",'MasCard',CHARISMA,charisma=10,endurance=10,emoji='<:epieu:932399920873357382>')
...
astroGlobe = weapon("Globe céleste",'cy',RANGE_LONG,AREA_CIRCLE_5,40,80,1,charisma=7,intelligence=7,endurance=1,effects=cardsDeck,use=CHARISMA,emoji='<:globe:932399865110093884>')
infDarkSword = weapon("Épée de l'Ombre Éternelle","cw",RANGE_MELEE,AREA_CIRCLE_1,power=51,sussess=85,strength=5,agility=10,effects=shareTabl[2],use=AGILITY,emoji='<:lunaWeap:915358834543968348>')
infLightSword = weapon("Épée de la Lueur Éternelle","cx",RANGE_MELEE,AREA_CIRCLE_1,power=51,sussess=85,resistance=5,charisma=10,effects=shareTabl[2],use=CHARISMA,emoji='<:lumSword:926874664175816735>')
...
magicSwordnShield = weapon("Bouclier Runique",'da',RANGE_MELEE,AREA_CIRCLE_1,62,70,1,magie=5,resistance=10,use=MAGIE,emoji='<:magicShield:934585318508736532>',needRotate=False,effects=shieltron)
...
fleau = weapon('Fléau de la Compréhension',"de",RANGE_MELEE,AREA_CIRCLE_2,58,50,1,charisma=10,resistance=5,use=CHARISMA,effects=fleauPassifEffect,emoji='<:fleau:934615644622704641>',area=AREA_ARC_1)
...
miltrilPlanisphere = weapon("Planisphère en mithril", 'dk', RANGE_LONG, AREA_CIRCLE_5, 40, 80, 1, charisma=7, intelligence=7,endurance=1, effects=miltrilPlanisftEff, use=INTELLIGENCE, emoji='<:planisMitrill:938379244856291388>')
...
fireMetRuneLong = weapon("Rune allongée des flammes","dl",RANGE_LONG,AREA_CIRCLE_6,33,60,1,magie=10,percing=5,area=AREA_CIRCLE_1,effects=tablWeapExp[0],use=MAGIE,emoji='<:fireLong:957759716484849754>',affinity=ELEMENT_FIRE,taille=0)
fireMetRuneMel = weapon("Rune de proximité des flammes","dm",RANGE_MELEE,AREA_CIRCLE_2,48,60,1,magie=10,resistance=5,area=AREA_CIRCLE_1,effects=tablWeapExp[0],use=MAGIE,emoji='<:fireMele:957759749716336640>',affinity=ELEMENT_FIRE,taille=0)
waterMetRuneLong = weapon("Rune allongée des courants","dn",RANGE_LONG,AREA_CIRCLE_6,46,60,1,magie=10,percing=5,effects=tablWeapExp[1],use=MAGIE,emoji='<:aqualong:957759791697125447>',affinity=ELEMENT_WATER,taille=0)
waterMetRuneMel = weapon("Rune de proximité des courants","do",RANGE_MELEE,AREA_CIRCLE_2,68,60,1,magie=10,resistance=5,effects=tablWeapExp[1],use=MAGIE,emoji='<:aquaMel:957759818393870336>',affinity=ELEMENT_WATER,taille=0)
airMetRuneMid = weapon("Rune étendue des vents","dp",RANGE_DIST,AREA_CIRCLE_4,40,60,1,magie=10,critical=5,area=AREA_CIRCLE_1,effects=tablWeapExp[2],use=MAGIE,emoji='<:airMid:957759962799562752>',affinity=ELEMENT_AIR,taille=0)
airMetRuneMel = weapon("Rune de proximité des vents","dq",RANGE_MELEE,AREA_CIRCLE_2,48,60,1,magie=10,resistance=5,area=AREA_CIRCLE_1,effects=tablWeapExp[2],use=MAGIE,emoji='<:airMel:957759933359751239>',affinity=ELEMENT_AIR,taille=0)
earthMetRuneMid = weapon("Rune étendue des sédiments","dr",RANGE_LONG,AREA_CIRCLE_4,58,60,1,magie=10,critical=5,effects=tablWeapExp[3],use=MAGIE,emoji='<:earthMid:957762288998305814>',affinity=ELEMENT_EARTH,taille=0)
earthMetRuneMel = weapon("Rune de proximité des sédiments","ds",RANGE_MELEE,AREA_CIRCLE_2,68,60,1,magie=10,resistance=5,effects=tablWeapExp[3],use=MAGIE,emoji='<:earthMel:957759999227097118>',affinity=ELEMENT_EARTH,taille=0)

lightMetRuneMid = weapon("Rune étendue des lueurs","dt",RANGE_DIST,AREA_CIRCLE_4,40,60,1,magie=10,percing=5,area=AREA_CIRCLE_1,effects=tablWeapExp[4],use=MAGIE,emoji='<:lightMid:957762377561014292>',affinity=ELEMENT_LIGHT,taille=0)
lightMetRuneLong = weapon("Rune allongée des lueurs","du",RANGE_LONG,AREA_CIRCLE_6,33,60,1,magie=10,critical=5,area=AREA_CIRCLE_1,effects=tablWeapExp[4],use=MAGIE,emoji='<:lightLong:957762401963474994>',affinity=ELEMENT_LIGHT,taille=0)
darkMetRuneMid = weapon("Rune étendue des ombres","dv",RANGE_DIST,AREA_CIRCLE_4,58,60,1,magie=10,critical=5,effects=tablWeapExp[5],use=MAGIE,emoji='<:darkMid:957762321709662339>',affinity=ELEMENT_DARKNESS,taille=0)
darkMetRuneLong = weapon("Rune allongée des ombres","dw",RANGE_LONG,AREA_CIRCLE_6,46,60,1,magie=10,percing=5,effects=tablWeapExp[5],use=MAGIE,emoji='<:darkMel:957762348876169257>',affinity=ELEMENT_DARKNESS,taille=0)
spaceMetRuneMid = weapon("Rune de proximité dimensionnelle","dx",RANGE_MELEE,AREA_CIRCLE_2,48,60,1,magie=10,resistance=5,area=AREA_CIRCLE_1,effects=tablWeapExp[6],use=MAGIE,emoji='<:spaceMel:957762429289369662>',affinity=ELEMENT_SPACE,taille=0)
spaceMetRuneLong = weapon("Rune allongée dimensionnelle","dy",RANGE_LONG,AREA_CIRCLE_6,33,60,1,magie=10,percing=5,area=AREA_CIRCLE_1,effects=tablWeapExp[6],use=MAGIE,emoji='<:spaceLong:957762451515011112>',affinity=ELEMENT_SPACE,taille=0)
timeMetRuneMid = weapon("Rune étendue temporelle","dz",RANGE_DIST,AREA_CIRCLE_4,58,60,1,magie=10,critical=5,effects=tablWeapExp[7],use=MAGIE,emoji='<:timeMid:957762503629226064>',affinity=ELEMENT_TIME,taille=0)
timeMetRuneLong = weapon("Rune allongée temporelle","ea",RANGE_LONG,AREA_CIRCLE_6,46,60,1,magie=10,percing=5,effects=tablWeapExp[7],use=MAGIE,emoji='<:timeLong:957762475351244810>',affinity=ELEMENT_TIME,taille=0)

iliSwoShield = weapon("Epée et Bouclier de la Lumière","eb",RANGE_MELEE,AREA_CIRCLE_1,58,75,1,resistance=5,charisma=10,effects=shieltron,use=CHARISMA,emoji='<:iliShield:975785889512976434>',affinity=ELEMENT_LIGHT)
flumShield = weapon("Epée et Bouclier de la Fleur Lumineuse","ec",RANGE_MELEE,AREA_CIRCLE_1,58,75,1,charisma=10,resistance=5,effects="lz",use=CHARISMA,affinity=ELEMENT_LIGHT,emoji='<:flumShield:964467183952465921>')
...
dflumShield = weapon("Epée et Bouclier de la Fleur Ténèbreuse","ef",RANGE_MELEE,AREA_CIRCLE_1,58,75,1,magie=10,resistance=5,effects="nt",use=MAGIE,affinity=ELEMENT_DARKNESS,emoji='<:darkShield:964467248486047765>')
...
constShield = weapon("Bouclier Constitutionnel",'eh',RANGE_MELEE,AREA_CIRCLE_1,48,90,1,endurance=10,resistance=5,use=ENDURANCE,emoji='<:constShield:964463485968859137>',effects="mk")
...
liaKatana = weapon("Akashi","el",RANGE_MELEE,AREA_CIRCLE_1,29,50,repetition=3,effects=liaKatanaEff,agility=10,endurance=5,use=AGILITY,emoji='<:liaKat:998001500267749448>',price=1)
...
# Weapon
weapons = [dSixtineWeap,phenixLeath,liaKatana,epiphyllum,
