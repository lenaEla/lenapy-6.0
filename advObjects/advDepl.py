...
lohicaDeplSkill = skill("Brouillard Empoisonné","lohicaDeplSkill",TYPE_INDIRECT_DAMAGE,range=AREA_MONO,area=AREA_CIRCLE_2,effects="me",effPowerPurcent=70,emoji="<:est:884223390804766740>",use=MAGIE)
lohicaDepl = depl("Brouillard Empoisonné",lohicaDeplSkill,["<:lodelp:1014079478248521738>","<:lodelp:1014079478248521738>"],["<:tlodelpB:1014079507877081110>","<:tlodelpR:1014079530199166996>"],"Inflige {0} __{1}__ aux ennemis à l'intérieur du brouillard avec une puissance équivalante de **{2}%**".format("<:est:884223390804766740>","Poison d'Estialba",lohicaDeplSkill.effPowerPurcent))
