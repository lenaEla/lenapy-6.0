...
lavenderProtect = skill("Protection Lavande","lavenderProtect",TYPE_ARMOR,effects=[lavenderProtectEff1,lavenderProtectEff3],cooldown=3,description="Octroi {0} à la cible principale, et aux alliés proches de la cible, avec une moindre puissance".format(lavenderProtectEff1),emoji=lavenderProtectEff3.emoji[0][0],effectAroundCaster=[TYPE_ARMOR,AREA_SUMMONER,lavenderSmallProtectEff])
...
tacticoolerSkill = skill("Tacticooler","tacticoolerSkill",TYPE_PASSIVE,area=AREA_DONUT_2,range=AREA_MONO,effects=[tacticoolerSkillEff1, tacticoolerSkillEff2], emoji=tacticoolerSkillEff1.emoji[0][0],description="Lors de son invocation, le Distribucool octroi {0} et {1} aux alliés alentours".format(tacticoolerSkillEff1, tacticoolerSkillEff2))
