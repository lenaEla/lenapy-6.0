...
proOHEff = effect("Sur-Protection","proOHEff",emoji=uniqueEmoji('<:proOH:909278525528350720>'),turnInit=-1,power=30,description="Vous avez réusi à surpasser vos limites !\n\n**{0}**% de vos sur-soins sont donnés en armure\n\n__<:proOHArmor:909278718575394837> Overheath - Protecteur :__\nArmure Légère : Les armures légères n'absorbent pas de dégâts supplémentaires lors de leurs destructions\nEffet Remplaçable : Les effets remplaçables sont remplassés si le même effet avec une meilleure puissance est donné",unclearable=True,reject=["ly","lightaura2Pa"])
altOHEff = effect("Sur-Soins","altOHEff",emoji=uniqueEmoji('<:altOH:909278509145395220>'),turnInit=-1,power=50,description="Votre dévotion pour vos alliés vous permet de passer à la vitesse supérieur !\n\n**{0}**% de vos sur-soins sont donnés en armure\n\n__<:altOHArmor:909278749143490601> Overheath - Altruiste :__\nArmure Légère : Les armures légères n'absorbent pas de dégâts supplémentaires lors de leurs destructions\nEffet Remplaçable : Les effets remplaçables sont remplassés si le même effet avec une meilleure puissance est donné",unclearable=True,reject=["ly","lightaura2Pa"])
