...
estal = effect("Poison d'Estialba","me",emoji=uniqueEmoji('<:est:884223390804766740>'),turnInit=3,stat=MAGIE,description="Un virulant poison, faisant la sinistre renommée des fées de cette île",trigger=TRIGGER_START_OF_TURN,stackable=True,power=30,type=TYPE_INDIRECT_DAMAGE,lvl=3)
...
vampirismeEff = effect("Vampirisme","no",power=25,type=TYPE_HEAL,stat=CHARISMA,trigger=TRIGGER_AFTER_DAMAGE,description="Accorde au porteur un certain pourcentage de vol de vie, augmenté par les statistiques de l'entité à l'origine de l'effet",emoji=sameSpeciesEmoji('<:vampireB:900313575913062442>','<:vampireR:900313598130282496>'))
...
estal2 = effect("Poison d'Estialba II","nq",MAGIE,type=TYPE_INDIRECT_DAMAGE,trigger=TRIGGER_START_OF_TURN,power=int(estal.power/3),turnInit=3,emoji=uniqueEmoji('<:estialba2:900329155974008863>'),stackable=True)
bleeding2 = effect("Hémoragie II","nr",STRENGTH,power=int(bleeding.power/3),type=TYPE_INDIRECT_DAMAGE,trigger=TRIGGER_START_OF_TURN,turnInit=3,stackable=True,emoji=uniqueEmoji('<:bleeding2:900329311955984456>'))
