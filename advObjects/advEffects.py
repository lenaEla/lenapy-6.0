...
lightAuraEffect = effect("Aura de Lumière I","ly",CHARISMA,turnInit=-1,power=10,type=TYPE_INDIRECT_HEAL,trigger=TRIGGER_END_OF_TURN,emoji=sameSpeciesEmoji("<:AdL1:873549174052892672>","<:AdL2:873549232601182249>"),description="Bénissez vos alliés proches et offrez leur des soins sur plusieurs tours",area=AREA_CIRCLE_2,reject=["idoOHEff","proOHEff","altOHEff","lightaura2Pa"])
...
stuned = effect("Etourdi","mb",emoji=uniqueEmoji('<:stun:882597448898474024>'),turnInit=3,stun=True,description="L'utilisation d'un gros sort magique vous a vidé de votre énergie")
...
idoOHEff = effect("Apothéose","idoOHEff",emoji=uniqueEmoji('<:IdoOH:909278546172719184>'),turnInit=-1,power=15,description="Vous motivez vos alliés plus que jamais !\n\n**{0}**% de vos sur-soins sont donnés en armure\n\n__<:idoOHArmor:909278702783836170> Overheath - Idole :__\nArmure Légère : Les armures légères n'absorbent pas de dégâts supplémentaires lors de leurs destructions\nEffet Remplaçable : Les effets remplaçables sont remplassés si le même effet avec une meilleure puissance est donné",unclearable=True,reject=["ly","lightaura2Pa"])
proOHEff = effect("Sur-Protection","proOHEff",emoji=uniqueEmoji('<:proOH:909278525528350720>'),turnInit=-1,power=15,description="Vous avez réusi à surpasser vos limites !\n\n**{0}**% de vos sur-soins sont donnés en armure\n\n__<:proOHArmor:909278718575394837> Overheath - Protecteur :__\nArmure Légère : Les armures légères n'absorbent pas de dégâts supplémentaires lors de leurs destructions\nEffet Remplaçable : Les effets remplaçables sont remplassés si le même effet avec une meilleure puissance est donné",unclearable=True,reject=["ly","lightaura2Pa"])
altOHEff = effect("Sur-Soins","altOHEff",emoji=uniqueEmoji('<:altOH:909278509145395220>'),turnInit=-1,power=30,description="Votre dévotion pour vos alliés vous permet de passer à la vitesse supérieur !\n\n**{0}**% de vos sur-soins sont donnés en armure\n\n__<:altOHArmor:909278749143490601> Overheath - Altruiste :__\nArmure Légère : Les armures légères n'absorbent pas de dégâts supplémentaires lors de leurs destructions\nEffet Remplaçable : Les effets remplaçables sont remplassés si le même effet avec une meilleure puissance est donné",unclearable=True,reject=["ly","lightaura2Pa"])
lightAura2ActiveEff = effect("Charges lumineuses","lightaura2Ac",CHARISMA,trigger=TRIGGER_AFTER_DAMAGE,turnInit=2,stackable=True,type=TYPE_INDIRECT_HEAL,power=5,lvl=3,description="Les trois prochaines attaques que vous receverez déclancheront un effet de soins autour de vous",area=AREA_DONUT_2,emoji=lightAuraEffect.emoji)
