...
deterEff1 = effect("Détermination","lg",emoji=uniqueEmoji('<:determination:867894180851482644>'),turnInit=-1,lvl=1,description="Une fois par combat, en subissant des dégâts mortels, vous permet de transcender la mort et vous soigne de **{0}%** de vos PV max",power=50,type=TYPE_PASSIVE)
...
inkBrellaEff = effect("Toile du para-encre","lp",PURCENTAGE,overhealth=25,turnInit=-1,type=TYPE_ARMOR,trigger=TRIGGER_DAMAGE,emoji='<:splatbrellareverse:876079630749147196>')
...
menthe = effect("Mentiné","lu",CHARISMA,percing=3,resistance=3,critical=5,description="Boost la résistance, la pénétration et le critique de vos alliés",emoji=uniqueEmoji('<:menthe:867538622797054042>'))
...
missiles = effect("Ciblé","mf",emoji=uniqueEmoji('<:tentamissile:884757344397951026>'),stat=STRENGTH,description="Au début de son tour, le ciel tombera sur la tête du Ciblé et ses alliés proches !",trigger=TRIGGER_START_OF_TURN,power=50,type=TYPE_INDIRECT_DAMAGE,area=AREA_CIRCLE_1,stackable=True)
...
isoled = effect("Isolé","ml",emoji=uniqueEmoji('<:selfProtect:887743151027126302>'),description="S'isoler mentalement pôur ne pas faire attention au dégâts",overhealth=150,stat=INTELLIGENCE,trigger=TRIGGER_DAMAGE,type=TYPE_ARMOR)
...
lightspellshield = effect("Bouclier de lumière","mt",INTELLIGENCE,overhealth=20,type=TYPE_ARMOR,trigger=TRIGGER_DAMAGE,emoji=uniqueEmoji('<:lightspellbook:892963432222036018>'))
...
convertArmor = effect("Armure","nl",type=TYPE_ARMOR,turnInit=3,emoji=uniqueEmoji('<:converted:902527031663788032>'),trigger=TRIGGER_DAMAGE,stackable=True,lightShield=True)
...
darkFlumEff = effect("Fleur ténèbreuse","nt",turnInit=-1,description="En subissant des dégâts, applique l'effet \"Ténèbres floraux\" sur l'attaquant",emoji=uniqueEmoji('<:darkFlum:901849622685814814>'),callOnTrigger=darkFlumPoi,trigger=TRIGGER_AFTER_DAMAGE,onDeclancher=True)
...
lightAura2ActiveEff = effect("Charge de Lumière","lightaura2Ac",CHARISMA,trigger=TRIGGER_AFTER_DAMAGE,turnInit=2,stackable=True,type=TYPE_INDIRECT_HEAL,power=10,lvl=4,description="Les 4 prochaines attaques que vous receverez déclancheront un effet de soins autour de vous",area=AREA_CIRCLE_2,emoji="<:lightAura21:1106836834572582952>")
lightAura2PassiveEff = effect("Eclat de Lumière","lightaura2Pa",CHARISMA,turnInit=-1,trigger=TRIGGER_START_OF_TURN,type=TYPE_BOOST,unclearable=True,emoji="<:lightAura2:1106836809083781120>",callOnTrigger=lightAura2ActiveEff,description="Octroi \"Charge Lumineuse\" à chaques début de tours",reject=healStans)
