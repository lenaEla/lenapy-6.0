...
nostalgiaE = effect("Nostalgie","lm", stat=INTELLIGENCE,turnInit=2,strength=-10,magie=-10,resistance=-5,emoji=emojiMalus,description='Plonge le porteur dans ses souvenirs, le rendant plus vulnérable aux attaques')
...
convertArmor = effect("Armure","nl",type=TYPE_ARMOR,turnInit=5,emoji=stolenArmorEff.emoji,trigger=TRIGGER_DAMAGE,stackable=True,lightShield=True)
...
troubleEff = effect("Troublé","od", stat=CHARISMA,charisma=-15,intelligence=-15,type=TYPE_MALUS)
...
lightAura2PassiveEff = effect("Eclat de Lumière","lightaura2Pa", stat=CHARISMA,turnInit=-1,trigger=TRIGGER_START_OF_TURN,type=TYPE_BOOST,unclearable=True,emoji="<:lightAura2:1106836809083781120>",callOnTrigger=lightAura2ActiveEff,description="Octroi \"Charge Lumineuse\" à chaques début de tours",reject=healStans)
