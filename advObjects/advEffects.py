...
afterShockDmg = effect("Acharnement","ln", stat=MAGIE,turnInit=1,power=30,aggro=10,lvl=5,trigger=TRIGGER_AFTER_DAMAGE,type=TYPE_INDIRECT_DAMAGE,emoji=sameSpeciesEmoji('<:aftershock1:882889524122898452>','<:aftershock2:882889538886852650>'),description="Lorsque la porteur reçoit des dégâts, le lanceur de la compétence lui inflige des dégâts indirects supplémentaire")
