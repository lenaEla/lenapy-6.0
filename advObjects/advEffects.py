...
octoshield = effect("Bouclier Octarien","lo",agility=-100,overhealth=200,turnInit=-1,trigger=TRIGGER_DAMAGE,type=TYPE_ARMOR,absolutShield=True,stat=ENDURANCE)
...
darkFlumEff = effect("Fleur ténèbreuse","nt",turnInit=-1,description="En subissant des dégâts, applique l'effet \"Ténèbres floraux\" sur l'attaquant",emoji=uniqueEmoji('<:darkFlum:901849622685814814>'),callOnTrigger=darkFlumPoi,trigger=TRIGGER_AFTER_DAMAGE)
