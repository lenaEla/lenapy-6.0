...
onstageeff = effect("Euphorie","mr",CHARISMA,strength=12,intelligence=12,charisma=12,magie=12,resistance=5,description="C'est le moment de tout donner !",emoji=uniqueEmoji('<:alice:893463608716062760>'))
