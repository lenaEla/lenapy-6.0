...
octoShieldSkill1 = skill("Aura Protectrice",'octoShieldSkill1',TYPE_BOOST,range=AREA_MONO,effects=[octoShieldSkill1eff3,octoShieldSkill1eff],emoji=octoShieldSkill1eff.emoji[0][0],cooldown=5,description="Réduit les dégâts subis. Octroie une réduction de dégâts subis aux alliés proches trois tours durant")
...
octoMonkSkill1 = skill("Frappe Terre","ocotMonkSkill1",TYPE_DAMAGE,power=80,cooldown=4,damageOnArmor=1.5,armorConvert=50,armorSteal=50,range=AREA_CIRCLE_1,emoji='<:stonelame2:1156452894367825930>',condition=[EXCLUSIVE,ELEMENT,ELEMENT_UNIVERSALIS])
octoMonkSkill2 = skill("Frappe Air","ocotMonkSkill2",TYPE_DAMAGE,power=80,cooldown=4,knockback=2,range=AREA_CIRCLE_1,emoji='<:aerlame2:1156452871479496784>',condition=[EXCLUSIVE,ELEMENT,ELEMENT_UNIVERSALIS])
octoMonkSkill3Eff = copy.deepcopy(incurable)
octoMonkSkill3Eff.power, octoMonkSkill3Eff.turnInit = 30, 3
octoMonkSkill3 = skill("Frappe Feu","ocotMonkSkill3",TYPE_DAMAGE,power=80,cooldown=4,range=AREA_CIRCLE_1,effects=octoMonkSkill3Eff,emoji='<:firelame2:1156452806652330024>',condition=[EXCLUSIVE,ELEMENT,ELEMENT_UNIVERSALIS])
octoMonkSkill4Eff = copy.deepcopy(armorGetMalus)
octoMonkSkill4Eff.power, octoMonkSkill4Eff.turnInit = 30, 3
octoMonkSkill4 = skill("Frappe Eau","ocotMonkSkill4",TYPE_DAMAGE,power=80,cooldown=4,range=AREA_CIRCLE_1,effects=octoMonkSkill4Eff,emoji='<:icelame2:1156452836964569148>',condition=[EXCLUSIVE,ELEMENT,ELEMENT_UNIVERSALIS])
...
malusSkill3 = skill("Brise-Défense","malusSkill3",TYPE_DAMAGE,power=80,area=AREA_CIRCLE_1,effects=[malusSkill3Eff,malusSkill3Eff3],cooldown=5,damageOnArmor=2,use=MAGIE)
...
veterHealSkill3Eff1 = effect("Poison","octaHealVet31", stat=CHARISMA,power=25,turnInit=3,type=TYPE_INDIRECT_DAMAGE,trigger=TRIGGER_START_OF_TURN,stackable=True,emoji='<:PoisonCard:1239301604625223721>')
...
lieWeap = weapon("Braise","lieWeap",RANGE_LONG,AREA_CIRCLE_4,31,95,area=AREA_CONE_2,charisma=10,magie=10,effects=lieWeapEff,use=MAGIE,emoji='<:lieWeap:908859856608460820>',effectOnUse=lizWeapEffExplo,priority=WEAPON_PRIORITY_LOWEST)
LIESKILLEFFGAIN = 35
...
# Cliroptère skill
clirHeal = skill("Clémence","stopSpamThatPls",TYPE_HEAL,0,75,cooldown=3,use=CHARISMA,effectAroundCaster=[TYPE_HEAL,AREA_MONO,75],range=AREA_DONUT_4)
clirPalWeapEff = effect("Bénédiction Nocturne","clirPalWeapEff",CHARISMA,power=20,area=AREA_CIRCLE_2,trigger=TRIGGER_WEAPON_USE,type=TYPE_INDIRECT_HEAL,emoji=selenomancie.emoji,turnInit=-1,unclearable=True,description="Soigne le porteur et ses alliés alentours lorsque ce premier utilise son arme")
clirWeap = weapon("Bouclier Nocturne","clirWeap",RANGE_MELEE,AREA_CIRCLE_1,80,60,charisma=10,resistance=10,endurance=10,use=CHARISMA,emoji='<:alMainCb1:1080150415632498788>',effects=clirPalWeapEff)
clirSkill1 = skill("Frappe Nocturne","clirSkill1",TYPE_DAMAGE,power=85,use=CHARISMA,effectAroundCaster=[TYPE_HEAL,AREA_CIRCLE_3,35],emoji=requiescat.emoji,cooldown=4)
...
unformTimeSkill1 = skill("Vision Aforme","unformTimeSkill1",TYPE_ARMOR,area=AREA_CIRCLE_2,cooldown=5,effects=unformTimeWeapEff,effPowerPurcent=150,emoji='<:time1:1095254189950640148>',description="Octroie une armure aux alliés ciblés")
...
imeaSkill2 = skill("Lames de glace","imeaSkill2",TYPE_DAMAGE,power=80,cooldown=5,effects=imeaDot,area=AREA_CIRCLE_2,use=MAGIE,emoji='<:imea3:1020057922190974997>',effPowerPurcent=75,condition=[EXCLUSIVE,ELEMENT,ELEMENT_WATER],description="Inflige des dégâts aux ennemis ciblé et octroie {0} {1} (75%) à la cible principale".format(imeaDot.emoji[0][0],imeaDot.name))
...
witchPoisonEff = effect("Poison","witchPoison", stat=MAGIE,power=25,turnInit=3,lvl=3,trigger=TRIGGER_START_OF_TURN,type=TYPE_INDIRECT_DAMAGE,emoji='<:PoisonCard:1239301604625223721>')
witchPoisonEff2 = copy.deepcopy(dmgDown)
witchPoisonEff2.power, witchPoisonEff2.stat, witchPoisonEff2.turnInit = 3, MAGIE, 3
witchPoisonSpell = skill("Fiole de Poison","witchPoisonSpell",TYPE_INDIRECT_DAMAGE,effects=[witchPoisonEff, witchPoisonEff2], emoji='<:PoisonCard:1239301604625223721>',cooldown=5,area=AREA_CIRCLE_2, description="Inflige des dégâts sur la durée et réduit les dégâts infligés par les ennemis ciblé pendant un petit instant")
...
ploufSkill2 = skill("Masque Renforcé","ploufSkill2",TYPE_PASSIVE,effectOnSelf=ploufSkill2e,description="Octroie une grosse quantité d'armure au début du combat")
...
voidSpell = skill("Néan","voidSpell",TYPE_DAMAGE,power=100,repetition=3,area=AREA_CIRCLE_1,use=MAGIE,emoji='<:VoidCard:1239299538074734683>',sharedDamage=True,cooldown=7,accuracy=200)

# bandit mage
mageBanditFireEff, mageBanditWaterEff, mageBanditAirEff, mageBanditEarthEff = effect("Maîtrise Feu","mageBanditFireEff",turnInit=-1,unclearable=True,emoji=elemEmojis[ELEMENT_FIRE]), effect("Maîtrise Eau","mageBanditWaterEff",turnInit=-1,unclearable=True,emoji=elemEmojis[ELEMENT_WATER]) ,effect("Maîtrise Air","mageBanditAirEff",turnInit=-1,unclearable=True,emoji=elemEmojis[ELEMENT_AIR]), effect("Maîtrise Terre","mageBanditEarthEff",turnInit=-1,unclearable=True,emoji=elemEmojis[ELEMENT_EARTH])
mageBanditWeapEff = effect("Maîtrise Elémentaire","mageBanditWeapEff",trigger=TRIGGER_INSTANT,emoji=elemEmojis[ELEMENT_UNIVERSALIS],description="Cet effet octroie aléatoirement {0}, {1}, {2} ou {3} au début du combat, modifiant les compétences et l'élément du Bandit Mage".format(mageBanditFireEff, mageBanditWaterEff, mageBanditAirEff, mageBanditEarthEff))
mageBanditWeap = weapon("Grimoire","mageBanditWeap",RANGE_LONG,AREA_CIRCLE_4,power=50,accuracy=80,priority=WEAPON_PRIORITY_NONE,magie=20,effects=mageBanditWeapEff)

mageBanditSkill1_3_ne = effect("Magie élémentaire 2","mageBanditSkill1_3_ne",turnInit=3,silent=True,emoji=destruction.emoji)
mageBanditSkill1_2_ne = effect("Magie élémentaire 1","mageBanditSkill1_2_ne",turnInit=3,silent=True,emoji='<:infusion:1123148866548662363>')

mageBanditSkill1_3_1 = skill("Giga Feu", "", TYPE_DAMAGE, use=MAGIE, power=100, needEffect=[mageBanditFireEff,mageBanditSkill1_3_ne], emoji='<:fire3:1042349767411376148>')
mageBanditSkill1_2_1 = skill("Méga Feu", "", TYPE_DAMAGE, use=MAGIE, power=85, needEffect=[mageBanditFireEff,mageBanditSkill1_2_ne], effectOnSelf=mageBanditSkill1_3_ne, emoji='<:majorFire2:1042349795353825320>')
mageBanditSkill1_1_1 = skill("Feu", "", TYPE_DAMAGE, use=MAGIE, power=70, needEffect=[mageBanditFireEff], rejectEffect=[mageBanditSkill1_2_ne,mageBanditSkill1_3_ne], effectOnSelf=mageBanditSkill1_2_ne, emoji='<:enemyFire:1042312985407930428>')
mageBanditSkill1_3_2 = skill("Giga Eau", "", TYPE_DAMAGE, use=MAGIE, power=100, needEffect=[mageBanditWaterEff,mageBanditSkill1_3_ne], emoji='<:water3:1065647689129271397>')
mageBanditSkill1_2_2 = skill("Méga Eau", "", TYPE_DAMAGE, use=MAGIE, power=85, needEffect=[mageBanditWaterEff,mageBanditSkill1_2_ne], effectOnSelf=mageBanditSkill1_3_ne, emoji='<:water2:1065647727708483654>')
mageBanditSkill1_1_2 = skill("Eau", "", TYPE_DAMAGE, use=MAGIE, power=70, needEffect=[mageBanditWaterEff], rejectEffect=[mageBanditSkill1_2_ne,mageBanditSkill1_3_ne], effectOnSelf=mageBanditSkill1_2_ne, emoji='<:water1:1065647748826791966>')
mageBanditSkill1_3_3 = skill("Giga Vent", "", TYPE_DAMAGE, use=MAGIE, power=100, needEffect=[mageBanditAirEff,mageBanditSkill1_3_ne], emoji='<:verAero3:1042350960321769503>')
mageBanditSkill1_2_3 = skill("Méga Vent", "", TYPE_DAMAGE, use=MAGIE, power=85, needEffect=[mageBanditAirEff,mageBanditSkill1_2_ne], effectOnSelf=mageBanditSkill1_3_ne, emoji='<:extraVerVent:946042871176396871>')
mageBanditSkill1_1_3 = skill("Vent", "", TYPE_DAMAGE, use=MAGIE, power=70, needEffect=[mageBanditAirEff], rejectEffect=[mageBanditSkill1_2_ne,mageBanditSkill1_3_ne], effectOnSelf=mageBanditSkill1_2_ne, emoji='<:enemyAer:1042313031926947920>')
mageBanditSkill1_3_4 = skill("Giga Terre", "", TYPE_DAMAGE, use=MAGIE, power=100, needEffect=[mageBanditEarthEff,mageBanditSkill1_3_ne], emoji='<:stone4:1053730609685602344>')
mageBanditSkill1_2_4 = skill("Méga Terre", "", TYPE_DAMAGE, use=MAGIE, power=85, needEffect=[mageBanditEarthEff,mageBanditSkill1_2_ne], effectOnSelf=mageBanditSkill1_3_ne, emoji='<:enemyStone:1042313085400133632>')
mageBanditSkill1_1_4 = skill("Terre", "", TYPE_DAMAGE, use=MAGIE, power=70, needEffect=[mageBanditEarthEff], rejectEffect=[mageBanditSkill1_2_ne,mageBanditSkill1_3_ne], effectOnSelf=mageBanditSkill1_2_ne, emoji='<:stone1:1053730561648246804>')

mageBanditSkill1 = skill("Combo élémentaire","mageBanditSkill1",TYPE_DAMAGE,emoji=mageBanditSkill1_2_ne.emoji[0][0],become=[mageBanditSkill1_3_1,mageBanditSkill1_2_1,mageBanditSkill1_1_1,mageBanditSkill1_3_2,mageBanditSkill1_2_2,mageBanditSkill1_1_2,mageBanditSkill1_3_3,mageBanditSkill1_2_3,mageBanditSkill1_1_3,mageBanditSkill1_3_4,mageBanditSkill1_2_4,mageBanditSkill1_1_4])
mageBanditElemDict = {mageBanditFireEff.id:ELEMENT_FIRE, mageBanditWaterEff.id:ELEMENT_WATER, mageBanditAirEff.id:ELEMENT_AIR, mageBanditEarthEff.id:ELEMENT_EARTH}
for indx, tmpSkill in enumerate(mageBanditSkill1.become): mageBanditSkill1.become[indx].id, mageBanditSkill1.become[indx].condition, mageBanditSkill1.become[indx].range = mageBanditSkill1.id, [EXCLUSIVE, ELEMENT, mageBanditElemDict[tmpSkill.needEffect[0].id]], AREA_CIRCLE_4

mageBanditSkill2_1 = skill("Extra Feu", "", TYPE_DAMAGE, power=100, area=AREA_CIRCLE_1, use=MAGIE, cooldown=3, emoji=fireCircle.emoji, needEffect=mageBanditFireEff)
mageBanditSkill2_2 = skill("Extra Eau", "", TYPE_DAMAGE, power=100, area=AREA_CIRCLE_1, use=MAGIE, cooldown=3, emoji=waterCircle.emoji, needEffect=mageBanditWaterEff)
mageBanditSkill2_3 = skill("Extra Vent", "", TYPE_DAMAGE, power=100, area=AREA_CIRCLE_1, use=MAGIE, cooldown=3, emoji=airCircle.emoji, needEffect=mageBanditAirEff)
