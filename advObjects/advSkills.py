...
bloodMoon = skill("Levée de la Lune de Sang",getAutoId(ripping.id,True),TYPE_BOOST,price=750,cooldown=5,area=AREA_CIRCLE_2,effects=[bloodMoonEff,bloodMoonEff2],emoji='<:BloodMoon:1094026774448443512>',description="Augmente les dégâts infligés par les alliés ciblés et leur octroi un pourcentage de vol de vie",condition=[EXCLUSIVE,ELEMENT,ELEMENT_SPACE])
blueMoonEff2 = copy.deepcopy(convertEff)
blueMoonEff2.stat, blueMoonEff2.power = bloodMoonEff2.stat, bloodMoonEff2.power
blueMoon = skill("Levée de la Lune Blue",getAutoId(bloodMoon.id,True),TYPE_BOOST,price=750,cooldown=5,area=AREA_CIRCLE_2,effects=[bloodMoonEff,blueMoonEff2],emoji='<:blueMoon:1094026561784643604>',description="Augmente les dégâts infligés par les alliés ciblés et convertie une partie des dégâts qu'ils infligent en armure",condition=[EXCLUSIVE,ELEMENT,ELEMENT_SPACE])
...
newMoon = skill("Levée de la Nouvelle Lune",getAutoId(blueMoon.id,True),TYPE_MALUS,price=750,cooldown=5,area=AREA_CIRCLE_2,effects=[newMoonEff,newMoonEff2],emoji='<:newMoon:1094026598690324573>',description="Réduits les dégâts infligés par les ennemis ciblés ainsi que l'armure qu'ils reçoivent",condition=[EXCLUSIVE,ELEMENT,ELEMENT_SPACE])
fullMoon = skill("Levée de la Pleine Lune",getAutoId(newMoon.id,True),TYPE_MALUS,price=750,cooldown=5,area=AREA_CIRCLE_2,effects=[newMoonEff,incur[2]],emoji='<:newMoon:1094026598690324573>',description="Réduits les dégâts infligés par les ennemis ciblés ainsi que les soins qu'ils reçoivent",condition=[EXCLUSIVE,ELEMENT,ELEMENT_SPACE])
