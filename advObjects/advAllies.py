...
tablAllAllies = [
    ...
    tmpAllie("Elina", 1, 0x560909, ALTRUISTE, serringue, [urgChirHat, urgChirDress, urgChirShoes], GENDER_FEMALE, [preciChi, cure, adrenaline, terachole, cure2Bundle, refConc, temperance], element=[ELEMENT_LIGHT, ELEMENT_NEUTRAL], icon='<:elina:950542889623117824>', bonusPoints=[CHARISMA, PRECISION]),
    ...
    tmpAllie("Amary",1, 0xdb6163, IDOLE, flumWand, [pinkbutbar,pinkbutterflyshirt,pinkbutterflysandals], GENDER_FEMALE, [croissance, descart, petalisation, roseeHeal, floraisonFinale, theSkill],"Floraaaaaaaa ?",[ELEMENT_EARTH,ELEMENT_AIR],deadIcon='<:amaryDown:979440197127262218>',icon='<:amary:979441677460713502>',bonusPoints=[CHARISMA,INTELLIGENCE])
]
...
tablVarAllies = [
    ...
    tmpAllie("Altikia", 2, 0xDFFF92, VIGILANT, fleau, [zenithHat, zenithArmor, zenithBoots], GENDER_FEMALE, [ironWillSkill, holyShieltron, lightBigHealArea, renisurection, concen, clemency, regenVigil],"Une personnalité de Gwen qui préfère se concentrer sur ses alliés", [ELEMENT_LIGHT, ELEMENT_FIRE], variant=True, bonusPoints=[ENDURANCE, CHARISMA], icon='<:alty:906303048542990347>', say=altySays),
...
# Balancing
areaDmgReductionTmp = effect("Dégâts de zone réduits","areaDmgReductionTmp",emoji='<:aoeDown:979953519350149130>',power=25,turnInit=-1,unclearable=True,type=TYPE_MALUS,description="Les dégâts infligés par les compétences à zone d'effet sont réduits de **20%** sur les cibles secondaires")
healReductionTmp = effect("Soins effectués réduits","healReductionTmp",emoji='<:healDown:979953539918987315>',power=15,turnInit=-1,unclearable=True,type=TYPE_MALUS,description="La puissance des soins effectués est réduite de **15%**")
armorReductionTmp = effect("Armure donnée réduite","armorReductionTmp",emoji='<:armorDown:979953578556948531>',power=15,turnInit=-1,unclearable=True,description="Réduit la puissance des armures données de **15%**",type=TYPE_MALUS)
monoDmgReductionTmp = effect("Dégâts monocibles réduits","monoDmgReductionTmp",emoji='<:monoDown:979953496218533918>',power=15,turnInit=-1,unclearable=True,description="Réduit les dégâts monocibles infligés de **15%**",type=TYPE_MALUS)
healReciveReductionTmp = effect("Soins reçus diminués","healReciveReductionTmp",emoji="<:recivedHealDown:979953560689197117>",power=10,turnInit=-1,unclearable=True,description="Réduit les soins reçus de **10%**",type=TYPE_MALUS)
