...
clemExSkill4 = skill("Corps à Corps Sanglant","clemExSkill4",TYPE_DAMAGE,sussess=200,power=CLEMCOMB1POWER,effectOnSelf=clemExSkill45Cast,replay=True,range=AREA_INLINE_5,emoji='<:cac:932765903102291999>',tpCac=True,description="Effectue une succession d'attaque contre un ennemi. Le dernier coup du combo inflige des dégâts en ligne",use=MAGIE)
...
iliPreSkill1 = skill("Champ lumineux", 'iliSkill1', TYPE_INDIRECT_DAMAGE, effects=iliPrePoi, range=AREA_MONO, area=AREA_CIRCLE_3, use=CHARISMA, cooldown=4, effectAroundCaster=[TYPE_ARMOR, AREA_MONO, iliPreArmor], description='Donne un effet de dégâts indirects aux ennemis alentours et vous procure une armure', emoji='<:iliLightField:1046381182767603752>')
...
iliPreSkill2Shield = skill("Armure de lumière","iliSkill2", TYPE_ARMOR, effects=iliPreArmor,cooldown=iliPreSkill2Heal.cooldown,range=iliPreSkill2Heal.range,emoji='<:illumi1:902008944887746611>',description="Procure une grosse armure à l'allié ciblé",effPowerPurcent=1.2)
iliPreSkill2 = skill("Pouvoir de la lumière","iliSkill2",TYPE_HEAL,cooldown=3,become=[iliPreSkill2Heal,iliPreSkill2Shield], emoji= '<:lightHealShield:929322808654323733>')
iliPreSkill3 = skill("Tourbillon de Lumière", "iliSkill3", TYPE_DAMAGE, power=150, range=AREA_MONO,area=AREA_CIRCLE_2, use=CHARISMA, description="Inflige des dégâts aux ennemis alentours", emoji='<:revolLum:1033720380281597983>')
...
tablVarAllies = [
    ...
    tmpAllie("Clémence Exaltée", 2, 0x8F001C, ENCHANTEUR, clemExWeapon, [miniStuff, miniStuff, miniStuff], GENDER_FEMALE, [clemExSkill2, clemExSkill3, clemExSkill4, clemExSkill5, clemExSkill6, clemExBloodDemon], "WIP, revenez plus tard", [ELEMENT_DARKNESS, ELEMENT_LIGHT], icon='<:clemence:908902579554111549>', bonusPoints=[MAGIE, STRENGTH], say=clemExSay, deadIcon='<:AliceOut:908756108045332570>',variant=True),
...
findAllie("Shehisa").changeDict = [
    tempAltBuilds(20,stuffs=findAllie("Luna").stuff,skills=[dissimulation,physTraqnard,UmbralTravel,bundleFetu,carnage,assasinate,antConst],elements=[ELEMENT_DARKNESS,ELEMENT_DARKNESS],bonusPoints=[STRENGTH,AGILITY]),
    tempAltBuilds(20,aspiration=POIDS_PLUME,stuffs=findAllie("Luna").stuff,skills=[dissimulation,dreamInADream,bunshin,findSkill("Attaque Sournoise"),assasinate,redrum,florChaot],elements=[ELEMENT_DARKNESS,ELEMENT_LIGHT],bonusPoints=[STRENGTH,AGILITY])
]
