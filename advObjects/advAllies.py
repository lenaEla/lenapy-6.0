...
tablAllAllies = [
    ...
    tmpAllie("Icealia", 2, light_blue, PREVOYANT, blueButterfly, getStuffSet("Armurier Légendaire"), GENDER_FEMALE, [soulagementBundle, royalShield, haimaBundle, firstArmor, lightPulse, matriceShield, elemShield], element=[ELEMENT_LIGHT, ELEMENT_LIGHT], bonusPoints=[INTELLIGENCE, ENDURANCE], icon='<:icealia:909065559516250112>', equippedChips=[getChip("Un pour tous","Armure Initiale","Armures augmenté I",'Intelligence augmentée I',"Soins et armures réalisés augmentés")]),
