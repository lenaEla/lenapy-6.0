...
findAllie("Lily").changeDict = [tempAltBuilds(50,PREVOYANT,epiphyllum,stuffs=findAllie("Epiphyllum").stuff,skills=[demonArmor,demonArmor2,dmonReconstitution,dmonReconstitution2,demonConst,inkarmor,firstArmor],bonusPoints=[INTELLIGENCE,PRECISION])]
...
findAllie("Icealia").changeDict = [tempAltBuilds(35,PROTECTEUR,findWeapon("Bâton Lunaire"),stuffs=[findStuff("Coiffe de la pleine lune"),findStuff("Armure de la pleine lune"),findStuff("Bottes de la pleine lune")],skills=[royaleGardeSkill,findSkill("Cercle Fantômatique"),findSkill("Sélènomancie"),findSkill("Aura Armurière"),findSkill("Orbe défensif"),findSkill("Armure d'Encre"),findSkill("Pied au sec")],bonusPoints=[ENDURANCE,INTELLIGENCE],elements=[ELEMENT_LIGHT,ELEMENT_WATER])]
findAllie("Bénédicte").changeDict = [
    tempAltBuilds(30,IDOLE,findWeapon("Globe céleste"),stuffs=[ora50Hat,ora50Dress,ora50Shoes],skills=[findSkill("Terre Sacrée Étendue"),findSkill("Guide Divin"),findSkill("Equilibre de la Balance"),findSkill("Astrodynamie"),findSkill("Lotus Pourpre"),findSkill("Manafication"),findSkill("Eruption Solaire")],bonusPoints=[CHARISMA,MAGIE],elements=[ELEMENT_SPACE,ELEMENT_DARKNESS]),
    tempAltBuilds(30,ALTRUISTE,findWeapon("Canne de la Fleur Lumineuse"),stuffs=findAllie("Elina").stuff,skills=[findSkill("Constitution Divine"),findSkill("Bénédiction Avancée"),findSkill("Purification"),findSkill("Extra Medica"),findSkill("Pulsation Vitale"),findSkill("Offrande de misère")],elements=[ELEMENT_LIGHT,ELEMENT_FIRE])
]
