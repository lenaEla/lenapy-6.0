...
aliceLotus = createTmpChangeDict(35, 0, [courage], [hollyGround2], 50)
...
# Alliés temporaires =============================================================================
tablAllAllies = [
    tmpAllie("Lena", 1, light_blue, OBSERVATEUR, splatcharger, [amethystEarRings, lightBlueJacket, lightBlueFlats], GENDER_FEMALE, [waterlame, amirShotCast, contreDeSixte, matriceEmpli, doubleShot, invocAutTour, preciseShot],"Une inkling qui en a vu des vertes et des pas murs.\nPréfère rester loin de la mêlée et abattre ses ennemis à bonne distance", [ELEMENT_WATER, ELEMENT_NEUTRAL], icon='<:lena:909047343876288552>', bonusPoints=[STRENGTH, PRECISION], say=lenaSays,birthday=(19,1)),
    ...
    tmpAllie("Lohica", 1, purple, SORCELER, secretum, [darFlumOr, corruptPurpleVeste, corruptPurpleBoots], GENDER_FEMALE, [lohicaFocal, poisonus, poisonusPuit, propag, lohicaUltCast, fairyFligth, fairyBomb],"Une fée à l'histoire bien mouvementée. Spécialisée dans les poisons", [ELEMENT_DARKNESS, ELEMENT_WATER], bonusPoints=[MAGIE, INTELLIGENCE], icon='<:lohica:919863918166417448>', deadIcon='<:flowernt:894550324705120266>'),
    tmpAllie("Hélène", 2, white, ALTRUISTE, whiteSpiritWings, [butterflyEarRingsWhite, whiteChemVeste, whiteButterFlyBoots], GENDER_FEMALE, [cure, lapSkill, renisurection, fairyGarde, sumLightButterfly, cure2Bundle, lightHeal2],"Une fée qui estime qu'essayer de sauver la vie de ses alliés est plus efficace que si elle esseyait de terminer le combat elle-même", [ELEMENT_LIGHT, ELEMENT_FIRE], bonusPoints=[CHARISMA, INTELLIGENCE], icon='<:helene:906303162854543390>'),
    ...
    tmpAllie("Edelweiss", 1, 0xE0FFE7, PREVOYANT, bleuSpiritWings, [battleShieldHat, battleShieldUnif, battleShieldShoes], GENDER_FEMALE, [haimaSkill, krasis, pandaima, intelRaise, pepsis, kerachole, pneuma], element=[ELEMENT_EARTH, ELEMENT_WATER], icon='<:edelweiss:918451422939451412>', deadIcon="<:flowernt:894550324705120266>", bonusPoints=[INTELLIGENCE, ENDURANCE]),
    ...
    tmpAllie('Anna', 2, black, PROTECTEUR, lunarBonk, [fullMoonHat, fullMoonArmor, fullMoonBoots], GENDER_FEMALE, [royaleGardeSkill, darkShield, isolement,heartStone, haimaSkill, intelRaise, darkAmb], element=[ELEMENT_LIGHT, ELEMENT_WATER], icon='<:anna:943444730430246933>', bonusPoints=[ENDURANCE, INTELLIGENCE]),
    tmpAllie("Elina", 1, 0x560909, ALTRUISTE, serringue, [urgChirHat, urgChirDress, urgChirShoes], GENDER_FEMALE, [preciChi, cure, uberCharge, terachole, renisurection, refConc, reconst], element=[ELEMENT_LIGHT, ELEMENT_NEUTRAL], icon='<:elina:950542889623117824>', bonusPoints=[CHARISMA, PRECISION]),
    tmpAllie("Bénédicte", 1, white, MAGE, magicWood, [mysticHat, mysticBody, mysticBoots], GENDER_FEMALE, [genesis, comboVerMiracle, redemption, benitWater, divineBenediction, divineCircle, divineAbne], element=[ELEMENT_LIGHT, ELEMENT_LIGHT], bonusPoints=[MAGIE, CHARISMA], icon='<:benedict:958786319776112690>'),
    tmpAllie("Amary",1, 0xdb6163, IDOLE, flumWand, [pinkbutbar,pinkbutterflyshirt,pinkbutterflysandals], GENDER_FEMALE, [croissance, descart, petalisation, roseeHeal, floraisonFinale, theSkill, astrodyn],"Floraaaaaaaa ?",[ELEMENT_EARTH,ELEMENT_AIR],deadIcon='<:amaryDown:979440197127262218>',icon='<:amary:979441677460713502>',bonusPoints=[CHARISMA,INTELLIGENCE]),
    tmpAllie("Chûri",1,light_blue,MAGE,phenixLeath, [redbutbar, redbutterflyshirt, redButterFlyBoots], GENDER_FEMALE, [fairySlash, galvanisation, elemRuneSkill[ELEMENT_EARTH], raisingPheonix, earthCircle, magicEffGiver], "Ayant fini par s'ennuyer en attendant que l'infime partie d'elle même étant restée bloqué parmis les vivants réussise à la rejoindre, Chûri s'est liée d'amitié avec un phenix du nom de Hirono au point que ce dernier concenti à fusionner temporairement leurs âmes afin d'aider la fée à atteindre son but.\nDepuis, Chûri arpente le monde sous forme translucide ressemblant fortement à son ancien corps et Hirono apparait régulièrement à ses côtés pour lui porter assistance.",[ELEMENT_EARTH,ELEMENT_FIRE],False,"<:fairyOut:935335430814068786>","<:churi:992941366537633914>",[MAGIE,PRECISION])
]
...
aliceSkill1 = skill("Rénégération", "aliceSkill1", TYPE_INDIRECT_HEAL, 0,0, emoji="<a:aliceSkill1:914787461949960202>", effect=aliceSkill1Eff, cooldown=3)
...
aliceSkill2 = skill("Galvanisation", "aliceSkill2", TYPE_BOOST, 0, range=AREA_DONUT_6, area=AREA_CIRCLE_2, effect=aliceSkill2Eff, cooldown=3, emoji='<a:aliceSkill2:914791502931197962>', say=["Allez-s'y !", "On ne lâche rien !", "Il va falloir essayer un peu plus fort que ça..."])
...
aliceIndirectDmg = skill("Provecta Fluos Luminosus","aliceSkill3",TYPE_INDIRECT_DAMAGE,effect=[aliceIndirectDmgEff,aliceDotEff2],cooldown=5)
...
aliceSong2 = skill("Chant de la Vie","aliceSkill5",TYPE_INDIRECT_HEAL,range=AREA_MONO,effect=[aliceSong2Eff1,aliceSong2Eff2],cooldown=3)
...
aliceCoda1 = skill("Coda régénérant","aliceSkill6",TYPE_INDIRECT_HEAL,cooldown=3,effect=aliceCoda1Eff)
aliceCoda2 = skill("Coda offensif","aliceSkill6",TYPE_BOOST,cooldown=3,effect=aliceCoda2Eff,area=AREA_CIRCLE_1)
aliceCoda3 = skill("Coda défensif","aliceSkill6",TYPE_BOOST,cooldown=3,effect=aliceCoda3Eff,area=AREA_CIRCLE_1)
aliceCoda4 = skill("Coda galvanisant","aliceSkill6",TYPE_BOOST,cooldown=3,effect=aliceCoda4Eff,area=AREA_CIRCLE_1)
...
clemExSkill32 = skill("Hastae Noctis", "clemExSkill3", TYPE_DAMAGE, 0, power=350,use=MAGIE, cooldown=3, description="Inflige de lourd dégâts monocibles et vous soigne d'une partie des dégâts infligés\nTemps de rechargement partagé avec __Sanguis Hastis__\n__Puissance :__ {power}",lifeSteal=35,say=["Tu penses que tu va pouvoir tenir combien de temps comme ça ?","Tu t'es pris pour qui ?"])
...
tablVarAllies = [
    ...
    tmpAllie("Klironovia", 2, 0xF49206, BERSERK, klikliSword, [butterflyEarRingsDark, darkChemVeste, darkButterFlyBoots], GENDER_FEMALE, [demolish, bloodBath, bloodyStrike, absorbingStrike2, klikliStrike, holmgang, bloodPact],"Une personnalité de Gwen bien plus violente que les deux autres", [ELEMENT_EARTH, ELEMENT_TIME], variant=True, bonusPoints=[STRENGTH, AGILITY], icon='<:klikli:906303031837073429>', say=klikliSays),
    tmpAllie("Shihu", 1, 0x00002D, MAGE, darkMetRuneMid, [shihuHat, shihuDress, shihuShoe], GENDER_FEMALE, [dark2, dark3, suppr, darkBoomCast, quickCast, mageSkill, maitriseElementaire],"\"Eye veut zuste un pi d'attenchions...\" - Shushi", [ELEMENT_DARKNESS, ELEMENT_SPACE], variant=True, icon='<:shihu:909047672541945927>', bonusPoints=[MAGIE, STRENGTH], say=shihuSays),
    ...
    tmpAllie('Belle', 2, 0x1f0004, ENCHANTEUR, magicSwordnShield, [magicArmorHelmet, magicArmorBody, magicArmorBoots], GENDER_FEMALE, [ferocite, dark3, darkAmb, innerdarkness, magicRuneStrike, strengthOfDesepearance, undead], element=[ELEMENT_DARKNESS, ELEMENT_NEUTRAL], variant=True, icon='<:belle:943444751288528957>', bonusPoints=[ENDURANCE, MAGIE]),
    ...
    tmpAllie("Alice alt.",1,aliceColor,POIDS_PLUME,aliceFan,[dans50Hat,dans50Dress,dans50Shoes],GENDER_FEMALE,[finalTech,swordDance,aliceFanDanse,courage,danseStarFall,tangoEnd,partner],element=[ELEMENT_SPACE,ELEMENT_LIGHT],variant=True,deadIcon=tablAllAllies[3].deadIcon,icon=tablAllAllies[3].icon,bonusPoints=[AGILITY,CHARISMA],say=tablAllAllies[3].says)
]
# FindAllies
...
armorReductionTmp = effect("Armure donnée réduite","armorReductionTmp",emoji='<:armorDown:979953578556948531>',power=15,turnInit=-1,unclearable=True,description="Réduit la puissance des armures données de **{0}%**",type=TYPE_MALUS)
