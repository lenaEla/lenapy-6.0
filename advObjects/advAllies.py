...
tablAllAllies = [
    ...
    tmpAllie("Shehisa", 1, purple, TETE_BRULE, shehisa, [redBatEarRingsred , batRedChemVeste, redBatBoots], GENDER_FEMALE, [heriteLesath, focus, dissimulation, bleedingPuit, hemoBomb, ShiUltimate, bleedingConvert],"Soeur d'Hélène, elle a elle aussi choisi de s'enroler dans la milice, mais étant trop timide pour faire face à ses adversaires, Shehisa a opté pour une stratégie un peu moins nombre qui consiste à piéger les zones et à regarder ses ennemis se vider de leur sang de loin", element=[ELEMENT_DARKNESS,ELEMENT_WATER], bonusPoints=[STRENGTH, INTELLIGENCE], icon='<:shehisa:919863933320454165>',say=shehisaSays),
    ...
    tmpAllie('Ly', 1, white, ATTENTIF, firework, [critIndStrHat45, critIndStrBody45, critIndStrShoes45], GENDER_FEMALE, [acidRain, coroRocket, quadFleau, coroMissile, coroShot, morsCaudiqueSkill, lanceTox],"Une mercenaire rencontrée sur les îles\nElle préfère rester loin et innonder ses ennemis avec ses attaques de zones", [ELEMENT_FIRE, ELEMENT_SPACE], icon='<:ly:943444713212641310>', bonusPoints=[STRENGTH, PRECISION], say=lySays),
...
accelerant.effect = [lunaQuickFightEff]
