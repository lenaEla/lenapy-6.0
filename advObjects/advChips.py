...
chipList = [
    ...
    chip("Force augmentée II",statsEmojis[STRENGTH],RARITY_COMMUN,"Augmente votre **Force** de **%power%**",5,15),
    ...
    chip("Endurance augmenté II",statsEmojis[ENDURANCE],RARITY_COMMUN,"Augmente votre **Endurance** de **%power%**",5,15),
    ...
    chip("Charisme augmenté II",statsEmojis[CHARISMA],RARITY_COMMUN,"Augmente votre **Charisme** de **%power%**",5,15),
    chip("Agilité augmentée I",statsEmojis[AGILITY],RARITY_COMMUN,"Augmente votre **Agilité** de **%power%** de votre niveau (**%lvlPower**)",15,40),
    chip("Agilité augmentée II",statsEmojis[AGILITY],RARITY_COMMUN,"Augmente votre **Agilité** de **%power%**",5,15),
    chip("Précision augmentée I",statsEmojis[PRECISION],RARITY_COMMUN,"Augmente votre **Précision** de **%power%** de votre niveau (**%lvlPower**)",15,40),
    chip("Précision augmentée II",statsEmojis[PRECISION],RARITY_COMMUN,"Augmente votre **Précision** de **%power%**",5,15),
    ...
    chip("Intelligence augmentée II",statsEmojis[INTELLIGENCE],RARITY_COMMUN,"Augmente votre **Intelligence** de **%power%**",5,15),
    chip("Magie augmentée I",statsEmojis[MAGIE],RARITY_COMMUN,"Augmente votre **Magie** de **%power%** de votre niveau (**%lvlPower**)",25,60),
    chip("Magie augmentée II",statsEmojis[MAGIE],RARITY_COMMUN,"Augmente votre **Magie** de **%power%**",5,15),
    ...
    chip("Achèvement","<:assassination:1157411186514596002>",RARITY_LEGENDARY,"Lorsque vous effectuez une attaque directe sur un adversaire ayant moins de **35%** de ses PVs max, la puissance de votre attaque est augmentée de **%power%**",20,40),
    ...
    chip("Totem de Protection","<:undying:1220101605412835359>",RARITY_MYTHICAL,"Une fois par combat, lorsque vos PVs tombent en dessous de 0, vous soigne immédiatement de **%power%** de vos PVs maximums, vous octroi une armure équivalente à **%power%** de vos PVs maximums, réduit de **50%** vos dégâts subis et vous octroi un effet régénérant équivalent aux soins initiaux durant un petit moment",15,25),
    ...
    chip("Overpower","<:sanguisDaemonium:1050059965630533714>",RARITY_MYTHICAL,"Une fois par combat, en utilisant votre compétence ultime, augmente la puissance et/ou celle des effets infligés ou octroyés de **%power%**, mais elle vous coûtera **50%** de vos PVs actuels",50,100),
    ...
    chip("Précaution","<:bpotion:867165268911849522>",RARITY_RARE,"Lors du **Tour 2**, vous octroi un effet régénérant **%power%** de vos PVs maximums en fin de tour durant cinq tours",3.5,10),
    chip("Radiance Toxique","<:chipToxiHeal:1221119824223014924>",RARITY_LEGENDARY,"En fin de tour, soigne les allies autour de vous de **%power%** des dégâts indirects infligés entre vos tours",10,25),
    ...
    chip("Armure Initiale","<:armorPack:1063490980759748789>",RARITY_MYTHICAL,"Au début du combat, octroi à toute votre équipe une armure équivalante à **%power%** de vos PVs maximums",20,35),
    ...
    chip("Contre-Offensive",'<:chipOffensifCounter:1218696364855132280>',RARITY_LEGENDARY,"Après avoir bloqué **5** attaques (ou **1** venant d'un boss Stand Alone), votre prochaine attaque monocible voit sa puissance augmenter de **%power%** de votre niveau (**%lvlPower**) et son vol de vie de **20%**",25,50),
    ...
    chip("Goût du Sang","<:bloodpact:937361536043843595>",RARITY_RARE,"En fin de tour, vous soigne de l'équivalent de **%power%** des dégâts infligés ou des soins réduits avec l'effet Blessure Profonde",35,75),
    chip("Lune de Sang","<:BloodMoon:1094026774448443512>",RARITY_LEGENDARY,"Lorsque vous infligez des dégâts directs, les cibles subbissent Blessure Profonde avec une valeur équivalente à **%power%** des dégâts infligés en plus",10,20),
