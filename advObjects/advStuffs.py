...
newMoonHat = stuff("Coiffe de la nouvelle lune","oy",0,1,endurance=20,intelligence=30,resistance=20,negativeShield=-20,negativeHeal=30,precision=-10,strength=-30)
newMoonArmor = stuff("Armure de la nouvelle lune","oz",1,1,endurance=30,intelligence=25,resistance=20,negativeShield=-15,negativeHeal=30,agility=-10,magie=-30)
newMoonBoots = stuff("Bottes de la nouvelle lune","pa",2,1,endurance=20,intelligence=30,resistance=20,negativeShield=-20,negativeHeal=30,charisma=-10,negativeBoost=30)

fullMoonHat = stuff("Coiffe de la pleine lune","pb",0,1,endurance=30,intelligence=40,resistance=20,negativeShield=-25,negativeHeal=35,precision=-30,strength=-30)
fullMoonArmor = stuff("Armure de la pleine lune","pc",1,1,endurance=40,intelligence=30,resistance=30,negativeShield=-20,negativeHeal=35,agility=-30,magie=-35)
fullMoonBoots = stuff("Bottes de la pleine lune","pd",2,1,endurance=30,intelligence=40,resistance=20,negativeShield=-25,negativeHeal=35,charisma=-30,negativeBoost=30)

bunnyEars = stuff("Serre tête oreilles de lapin","pe",0,1,charisma=40,negativeBoost=-30,intelligence=30,precision=10,endurance=-20,resistance=-10,negativeShield=30,magie=-30)
bunnyBody = stuff("Juste-au-corps de lapin","pf",1,1,charisma=40,negativeBoost=-30,intelligence=30,precision=10,strength=-20,magie=-10,negativeIndirect=30,negativeHeal=30)
bunnyShoes = stuff("Escarpins de lapin","pg",2,1,charisma=40,negativeBoost=-30,intelligence=30,precision=10,agility=-20,resistance=-10,negativeDirect=30,strength=-30)