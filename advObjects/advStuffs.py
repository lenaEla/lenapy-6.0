...
julieHat = stuff("Coiffe de la soubrette écarlate","nx",0,1,endurance=5,charisma=40,negativeHeal=-30,negativeBoost=-20,negativeShield=25,strength=-30,magie=-20,emoji='<:julieHat:910192954671505428>',position=6)
...
whiteLily = stuff("Broche du lys blanc","pu",0,1,charisma=45,negativeHeal=-20,effect=flum.effect,emoji='<:whiteLily:914608227545673758>',strength=-30,magie=-25,position=barrette.position)
bloodLily = stuff("Broche du lys de sang","pv",0,1,magie=45,negativeDirect=-10,negativeIndirect=-10,effect=darkFlum.effect,emoji='<:bloodLily:914608243354001429>',charisma=-30,intelligence=-25,position=barrette.position)
...
corruptRedVeste = stuff("Veste corrompue rouge","rm",1,1,magie=45,negativeDirect=-45,precision=20,negativeIndirect=40,endurance=-10,resistance=-10,charisma=-20,emoji='<:redCorruptBody:916598576879116328>')
...
corruptPurpleVeste = stuff("Veste corrompue violette","ro",1,1,magie=45,negativeIndirect=-45,precision=20,negativeDirect=40,endurance=-10,resistance=-10,charisma=-20,emoji='<:purpleCorruptBody:916598609665998858>')
flumOr = stuff("Fleur lumineuse de la rosée du matin","rp",0,1,position=barrette.position,charisma=40,negativeHeal=-50,magie=20,negativeShield=40,intelligence=-30,agility=-30,effect=flum.effect,emoji='<:flum2:916593073369280552>')
darFlumOr = stuff("Fleur ténèbreuse de la rosée du soir","rq",0,1,position=barrette.position,magie=60,negativeIndirect=-30,charisma=20,negativeDirect=40,strength=-30,agility=-30,effect=darkFlum.effect,emoji='<:darkflum2:916593089743826974>')
