...
julieHat = stuff("Coiffe de la soubrette écarlate","nx",0,1,endurance=5,charisma=40,negativeHeal=-30,negativeBoost=-20,negativeShield=25,strength=-30,magie=-20,emoji='<:julieHat:918770694869876747>',position=6)
julieDress = stuff("Robe de la soubrette écarlate","nz",1,1,endurance=5,charisma=30,negativeHeal=-30,resistance=10,negativeBoost=-20,negativeShield=35,negativeDirect=20,negativeIndirect=20,emoji='<:julieDress:918770047684603976>')
julieShoes = stuff("Escarpins de la soubrette écarlate","oa",2,1,endurance=5,charisma=40,negativeHeal=-30,negativeBoost=-20,negativeShield=25,agility=-30,precision=-20,emoji='<:julieHeels:918770033319092224>')
...
magicArmorHelmet = stuff("Casque magicochromatique de l'EEv3","oe",0,1,endurance=45,magie=35,resistance=20,negativeDirect=-20,strength=-40,intelligence=-30,charisma=-30,emoji='<:magicHelmet:916193178032431155>')
magicArmorBody = stuff("Armure magicochromatique de l'EEv3","of",1,1,endurance=45,magie=25,resistance=25,negativeDirect=-20,strength=-35,intelligence=-30,charisma=-30,emoji='<:magicArmor:916193242507272202>')
magicArmorBoots = stuff("Bottes magicochromatique de l'EEv3","og",2,1,endurance=45,magie=35,resistance=20,negativeDirect=-20,strength=-40,intelligence=-30,charisma=-30,emoji='<:magicoBoots:916193195552022538>')
...
bunnyEars = stuff("Serre tête oreilles de lapin","pe",0,1,charisma=40,negativeBoost=-30,intelligence=30,precision=10,endurance=-20,resistance=-10,negativeShield=30,magie=-30,emoji='<:bunnyHeadset:912846454098374691>',position=6)
...
dragoonHelmet = stuff("Heaume du tankeur de sol","pr",0,1,strength=30,agility=20,endurance=10,resistance=10,percing=5,magie=-30,charisma=-20,negativeHeal=15,effect=floorTanking,emoji='<:floorTankHelmet:914608772247347200>')
dragoonArmor = stuff("Armure du tankeur de sol","ps",1,1,strength=20,agility=20,endurance=20,resistance=15,magie=-30,intelligence=-20,negativeHeal=15,effect=floorTanking,emoji='<:floorTankArmor:914608787187441665>')
dragoonBoots = stuff("Solerets du tankeur de sol","pt",2,1,strength=25,agility=30,endurance=5,resistance=10,percing=5,magie=-30,charisma=-20,negativeHeal=15,effect=floorTanking,emoji='<:floorTankBoots:914608812663652353>')
whiteLily = stuff("Broche du lys blanc","pu",0,1,charisma=40,negativeHeal=-20,effect=flum.effect,emoji='<:whiteLily:914608227545673758>',strength=-30,magie=-20,position=barrette.position)
bloodLily = stuff("Broche du lys de sang","pv",0,1,magie=40,negativeDirect=-10,negativeIndirect=-10,effect=darkFlum.effect,emoji='<:bloodLily:914608243354001429>',charisma=-30,intelligence=-20,position=barrette.position)
...
kryscharpe = stuff("Écharpe cristaline","ri",0,1,strength=35,endurance=35,resistance=15,negativeDirect=-15,intelligence=-50,magie=-30,emoji='<:cris:916156903137116210>',position=blueCharpe.position)
krysshirt = stuff("T-shirt cristalin","rj",1,1,strength=30,endurance=30,resistance=25,negativeDirect=-15,intelligence=-50,magie=-30,emoji='<:sta:916156917812969502>')
kryschains = stuff("Chaînes cristalines","rk",2,1,strength=35,endurance=35,resistance=15,negativeDirect=-15,intelligence=-50,magie=-30,emoji='<:line:916156940588040205>')

corruptRedBoots = stuff("Bottes corrompues rouges","rl",2,1,magie=40,negativeDirect=-40,percing=10,precision=10,negativeIndirect=40,strength=-40,emoji='<:redCorruptBoots:916598561158856705>')
corruptRedVeste = stuff("Veste corrompue rouge","rm",1,1,magie=45,negativeDirect=-45,precision=20,negativeIndirect=40,endurance=-10,resistance=-10,charisma=-20,agility=-10,emoji='<:redCorruptBody:916598576879116328>')
corruptPurpleBoots = stuff("Bottes corrompues violettes","rn",2,1,magie=40,negativeIndirect=-40,percing=10,precision=10,negativeDirect=40,strength=-40,emoji='<:purpleCorruptBoots:916598547045040149>')
corruptPurpleVeste = stuff("Veste corrompue violette","ro",1,1,magie=45,negativeIndirect=-45,precision=20,negativeDirect=40,endurance=-10,resistance=-10,charisma=-20,agility=-10,emoji='<:purpleCorruptBody:916598609665998858>')
flumOr = stuff("Fleur lumineuse de la rosée du matin","rp",0,1,position=barrette.position,charisma=40,negativeHeal=-35,magie=20,negativeShield=40,intelligence=-15,agility=-30,effect=flum.effect,emoji='<:flum2:916593073369280552>')
darFlumOr = stuff("Fleur ténèbreuse de la rosée du soir","rq",0,1,position=barrette.position,magie=45,negativeIndirect=-30,charisma=20,negativeDirect=40,strength=-15,agility=-30,effect=darkFlum.effect,emoji='<:darkflum2:916593089743826974>')
fullTempCharp = stuff("Écharpe dans son temps","rr",0,1,position=blueCharpe.position,negativeHeal=-45,negativeShield=-45,charisma=10,intelligence=10,negativeBoost=90,emoji='<:intemcharpev2:916591302940950578>')
fullTempVest = stuff("Veste dans son temps","rs",1,1,negativeHeal=-45,negativeShield=-45,charisma=10,intelligence=10,negativeBoost=90,emoji='<:intempJacketv2:916591288994902027>')
fullTempShoes = stuff("Tennis montantes dans son temps","rt",2,1,negativeHeal=-45,negativeShield=-45,charisma=10,intelligence=10,negativeBoost=90,emoji='<:intempshoesV2:916591275795427358>')
firstBar = stuff("Barette de la première heure","ru",0,1,position=barrette.position,strength=30,agility=30,precision=30,negativeDirect=-20,critical=-10,magie=-35,negativeIndirect=25,negativeBoost=20,emoji='<:firstBar:916596308989587486>')
firstUniform = stuff("Uniforme de la première heure","rv",1,1,strength=30,agility=30,precision=30,negativeDirect=-20,critical=-10,magie=-35,negativeHeal=25,negativeShield=20,emoji='<:firstUniform:916595102955216917>')
firstShoes = stuff("Tennis montantes de la première heure","rw",2,1,strength=30,agility=30,precision=30,negativeDirect=-20,critical=-10,magie=-35,negativeIndirect=25,negativeBoost=20,emoji='<:firstShoes:916595666527064064>')