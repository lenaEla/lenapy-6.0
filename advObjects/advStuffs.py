...
chrismasHat = stuff("Bonnet de Noël","hbd",0,1,charisma=35,negativeBoost=-15,negativeDirect=15,negativeIndirect=15)
chrismasPull = stuff("Pull de Noël","hbe",1,1,charisma=15,intelligence=15,resistance=5,negativeBoost=-15,negativeDirect=15,negativeIndirect=15)
chrismasBoots = stuff("Bottes de Noël","hbg",2,1,intelligence=35,negativeBoost=-15,negativeDirect=15,negativeIndirect=15)
nemeBracelet = stuff("Bracelets cloutés","hdh",0,1,strength=25,negativeDirect=-10,endurance=10,resistance=5,negativeHeal=15,negativeIndirect=15)
nemeManteau = stuff("Manteau à fourrure","hdi",1,1,strength=25,endurance=15,resistance=10,intelligence=-15,charisma=-15)
nemeBottes = stuff("Bottes cloutés","hdj",2,1,strength=25,negativeDirect=-10,endurance=10,resistance=5,magie=-15,negativeBoost=15)
...
redbutterflysandals = stuff("Sandales du papillon rouge","hdt",2,1,emoji='<:redButSand:926904356102619156>',magie=30,negativeDirect=-30,strength=-20,negativeIndirect=20,orientation=[LONG_DIST,MAGIC])
redbutterflyshirt = stuff("T-shirt du papillon rouge","hdu",1,1,emoji='<:redButShirt:926911750916411472>',magie=30,negativeDirect=-30,strength=-20,negativeIndirect=20,orientation=[LONG_DIST,MAGIC])
purplebutterflysandals = stuff("Sandales du papillon violet","hdv",2,1,emoji='<:purpleButSand:926904385253027900>',magie=30,negativeIndirect=-30,strength=-20,negativeDirect=20,orientation=[LONG_DIST,MAGIC])
purplebutterflyshirt = stuff("T-shirt du papillon violet","hdx",1,1,emoji='<:purpleButShirt:926911734533484574>',magie=30,negativeIndirect=-30,strength=-20,negativeDirect=20,orientation=[LONG_DIST,MAGIC])
darkbluebutterflysandals = stuff("Sandales du papillon bleu marine","hdy",2,1,emoji='<:bdbSand:926946181706293328>',magie=25,endurance=20,resistance=15,negativeHeal=20,negativeShield=20,orientation=[TANK,MAGIC])
darkbluebutterflyshirt = stuff("T-shirt du papillon bleu marine","hdz",1,1,emoji='<:dbbutShirt:926946132653903942>',magie=30,endurance=20,resistance=10,negativeShield=20,negativeBoost=20,orientation=[TANK,MAGIC])
darkblueChemVeste = stuff("Veste et robe papillon bleu marine","hea",1,1,emoji='<:dbbv:926947311353995314>',magie=40,endurance=30,resistance=20,strength=-40,negativeHeal=30,orientation=[TANK,MAGIC])
darkblueButterFlyBoots = stuff("Bottes du papillon bleu marine","heb",2,1,magie=30,agility=20,endurance=20,resistance=20,negativeShield=20,negativeHeal=30,negativeIndirect=20,emoji='<:dbb:926947327145558037> ',orientation=[TANK,MAGIC])
...
redbutbar = stuff("Barette du papillon rouge","heg",0,1,negativeDirect=-70,endurance=-10,resistance=-10,magie=-10,strength=-10,negativeIndirect=10,orientation=[LONG_DIST,MAGIC],position=barrette.position,emoji='<:redbutbar:926946208197509130>')
purplebutbar = stuff("Barette du papillon violet","heh",0,1,negativeIndirect=-70,endurance=-10,resistance=-10,magie=-10,strength=-10,negativeDirect=10,orientation=[LONG_DIST,MAGIC],position=barrette.position,emoji='<:purplebutbar:926946220688162938>')
darkbluebutbar = stuff("Barette du papillon bleu marine","hei",0,1,magie=30,endurance=30,resistance=10,charisma=-10,intelligence=-10,precision=-10,agility=-10,strength=-10,orientation=[TANK,MAGIC],position=barrette.position,emoji='<:dbbutbar:926946148021858325>')

# Stuff
stuffs =[darkbluebutterflysandals,darkbluebutterflyshirt,darkblueChemVeste,darkblueButterFlyBoots,pinkbutbar,whitebutbar,bluebutbar,darkbluebutbar,purplebutbar,redbutbar,
