...
phoenixFlight = effect("Vol du phénix","phoenixFlight",MAGIE,power=25,turnInit=3,type=TYPE_INDIRECT_HEAL,trigger=TRIGGER_START_OF_TURN,emoji='<:voldevie:946042594616561715>',description="Soigne le porteur en début de tour")
...
convictEnchtEff = effect("Conviction de l'Enchanteur","convVigil",MAGIE,power=50,type=TYPE_INDIRECT_HEAL,unclearable=True,turnInit=-1,description="Lorsque le porteur utilise son arme ou une compétence de dégâts directs, le soigne légèrement",emoji="<:AltyRegen:994748551932428319>")
...
convictTeteArmor = effect("Armure","convicTetAmor",STRENGTH,overhealth=35,stackable=True,lightShield=True,type=TYPE_ARMOR,trigger=TRIGGER_DAMAGE)
