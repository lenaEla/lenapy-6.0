...
lapinoSkill = skill("Murmure de dévoument","aaj",TYPE_HEAL,0,75,emoji='<:defHeal:885899034563313684>',cooldown=4,description="Soigne l'allié ciblé")

lapSkill3Eff = effect("Murmure d'Affaiblissement","lapSkill3Eff", stat=PURCENTAGE,resistance=-10,turnInit=3,emoji='<:resDown:1188192304788406333>')
...
lapinoSkill2 = skill("Murmure d'Abnégation","lapinoSkill2",TYPE_HEAL,power=135,use=CHARISMA,cooldown=3,initCooldown=3,description="Soigne l'allié ciblé mais le Lapino est vaincu par la suite",effectOnSelf=autoEff)
...
cutyBatSkill3Eff = effect("Onde Sonore","batEcho", stat=CHARISMA,power=50,type=TYPE_INDIRECT_DAMAGE,trigger=TRIGGER_INSTANT)
...
serafWeaponEff = effect("Voile Séraphique","serafWeapShield", stat=INTELLIGENCE,overhealth=50,stackable=True,trigger=TRIGGER_DAMAGE,type=TYPE_ARMOR,emoji='<:voileSeraphique:1066814843044249610>')
...
hinoroRegen = effect("Ravivement","hinoroRegen", stat=MAGIE,type=TYPE_INDIRECT_HEAL,trigger=TRIGGER_HP_ENDER_70,turnInit=3,callOnTrigger=hinoroRegen2,lvl=1,emoji='<:ravivement:1066085083796221952>',stackable=True)
...
titania = invoc("Titania",[PURCENTAGE,0.3],[PURCENTAGE,0.7],[PURCENTAGE,0.5],[PURCENTAGE,0.5],[PURCENTAGE,0.7],[PURCENTAGE,0.5],[PURCENTAGE,0.7],25,10,20,ENCHANTEUR,["<:tita1:886663550796431390>","<:tita2:886663565220651028>"],titWeap,[titPassive,titSkill1,titSkill2,titSkill3],GENDER_FEMALE,element=ELEMENT_UNIVERSALIS_PREMO,description="Une invocation magique qui inflige de lourd dégâts de zone",lifeTime=5)
lapino = invoc("Lapino",[PURCENTAGE,0.5],[PURCENTAGE,0.5],[PURCENTAGE,0.7],[PURCENTAGE,0.3],[PURCENTAGE,0.5],[PURCENTAGE,0.5],[PURCENTAGE,0.5],10,0,0,ALTRUISTE,['<:lapino1:885899366966112266>','<:lapino2:885899382539571221>'],lapinoWeap,[lapinoSkill,lapSkill3,lapinoSkill2],description="Fidèle Lapino d'Hélène, il la suit partout là où elle aura besoin de lui",element=ELEMENT_LIGHT)
...
myrlopeSkill2Eff1 = effect("Morsure Empoisonné","myrolpeSkill2eff1", stat=STRENGTH,power=20,turnInit=3,type=TYPE_INDIRECT_DAMAGE,trigger=TRIGGER_START_OF_TURN,emoji='<:poisonSpell:1042307610847748116>',stackable=True)
