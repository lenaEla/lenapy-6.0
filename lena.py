    ...
    if valid:
        ...
        if ((ctx.content.startswith(guild.prefixe) or ctx.content.startswith("l!")) and not(ctx.author.bot == True)):
            ...
            if args[0] == guild.prefixe + "settings" or args[0] == "l!settings":
                        ...
                        if user.team == "0":
                            ...
                            if len(file[0]) == 1:
                                ...
                                for a in file[0]:
                                    ...
                                    ballerine = f'<:empty:866459463568850954> {temp2.weapon.emoji} | {temp2.stuff[0].emoji} {temp2.stuff[1].emoji} {temp2.stuff[2].emoji} | '
                ...
                await shop2(bot,ctx,guild,args,shopping.shopping)
