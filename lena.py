...
async def normal(ctx):
    ...
    if fun < 0:                # For testing purposes
        ...
        try:
            await fight(slash, team1, team2, ctx, False, procurFight=procurFight, msg=msg, teamSettings=teamSettings)
        except:
            if msg == None:
